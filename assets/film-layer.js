...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:eJ,depthTest:!1,depthWrite:!1})}function $X(J,Q,$){let Z=new Float32Array(a9),W=new b(0,1,0);return new IJ({name:"SphericalGaussianBlur",defines:{n:a9,CUBEUV_TEXEL_WIDTH:1/Q,CUBEUV_TEXEL_HEIGHT:1/$,CUBEUV_MAX_MIP:`${J}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:Z},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:W}},vertexShader:l6(),fragmentShader:`
	...
	`}class J$ extends mJ{constructor(J=1,Q={}){super(J,J,Q);this.isWebGLCubeRenderTarget=!0;let $={width:J,height:J,depth:1},Z=[$,$,$,$,$,$];this.texture=new h6(Z),this._setTextureOptions(Q),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(J,Q){this.texture.type=Q.type,this.texture.colorSpace=Q.colorSpace,this.texture.generateMipmaps=Q.generateMipmaps,this.texture.minFilter=Q.minFilter,this.texture.magFilter=Q.magFilter;let $={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},Z=new L8(5,5,5),W=new IJ({name:"CubemapFromEquirect",uniforms:n9($.uniforms),vertexShader:$.vertexShader,fragmentShader:$.fragmentShader,side:CJ,blending:eJ});W.uniforms.tEquirect.value=Q;let K=new vJ(Z,W),H=Q.minFilter;if(Q.minFilter===x9)Q.minFilter=PJ;return new gQ(1,10,this).update(J,K),Q.minFilter=H,K.geometry.dispose(),K.material.dispose(),this}clear(J,Q=!0,$=!0,Z=!0){let W=J.getRenderTarget();for(let K=0;K<6;K++)J.setRenderTarget(this,K),J.clear(Q,$,Z);J.setRenderTarget(W)}}function ZX(J){let Q=new WeakMap,$=new WeakMap,Z=null;function W(G,O=!1){if(G===null||G===void 0)return null;if(O)return H(G);return K(G)}function K(G){if(G&&G.isTexture){let O=G.mapping;if(O===O6||O===k6)if(Q.has(G)){let L=Q.get(G).texture;return Y(L,G.mapping)}else{let L=G.image;if(L&&L.height>0){let z=new J$(L.height);return z.fromEquirectangularTexture(J,G),Q.set(G,z),G.addEventListener("dispose",U),Y(z.texture,G.mapping)}else return null}}return G}function H(G){if(G&&G.isTexture){let O=G.mapping,L=O===O6||O===k6,z=O===k8||O===h9;if(L||z){let D=$.get(G),E=D!==void 0?D.texture.pmremVersion:0;if(G.isRenderTargetTexture&&G.pmremVersion!==E){if(Z===null)Z=new rQ(J);return D=L?Z.fromEquirectangular(G,D):Z.fromCubemap(G,D),D.texture.pmremVersion=G.pmremVersion,$.set(G,D),D.texture}else if(D!==void 0)return D.texture;else{let _=G.image;if(L&&_&&_.height>0||z&&_&&X(_)){if(Z===null)Z=new rQ(J);return D=L?Z.fromEquirectangular(G):Z.fromCubemap(G),D.texture.pmremVersion=G.pmremVersion,$.set(G,D),G.addEventListener("dispose",N),D.texture}else return null}}}return G}function Y(G,O){if(O===O6)G.mapping=k8;else if(O===k6)G.mapping=h9;return G}function X(G){let O=0,L=6;for(let z=0;z<L;z++)if(G[z]!==void 0)O++;return O===L}function U(G){let O=G.target;O.removeEventListener("dispose",U);let L=Q.get(O);if(L!==void 0)Q.delete(O),L.dispose()}function N(G){let O=G.target;O.removeEventListener("dispose",N);let L=$.get(O);if(L!==void 0)$.delete(O),L.dispose()}function q(){if(Q=new WeakMap,$=new WeakMap,Z!==null)Z.dispose(),Z=null}return{get:W,dispose:q}}function WX(J){let Q={};function $(Z){if(Q[Z]!==void 0)return Q[Z];let W=J.getExtension(Z);return Q[Z]=W,W}return{has:function(Z){return $(Z)!==null},init:function(){$("EXT_color_buffer_float"),$("WEBGL_clip_cull_distance"),$("OES_texture_float_linear"),$("EXT_color_buffer_half_float"),$("WEBGL_multisampled_render_to_texture"),$("WEBGL_render_shared_exponent")},get:function(Z){let W=$(Z);if(W===null)b9("WebGLRenderer: "+Z+" extension not supported.");return W}}}function KX(J,Q,$,Z){let W={},K=new WeakMap;function H(q){let G=q.target;if(G.index!==null)Q.remove(G.index);for(let L in G.attributes)Q.remove(G.attributes[L]);G.removeEventListener("dispose",H),delete W[G.id];let O=K.get(G);if(O)Q.remove(O),K.delete(G);if(Z.releaseStatesOfGeometry(G),G.isInstancedBufferGeometry===!0)delete G._maxInstanceCount;$.memory.geometries--}function Y(q,G){if(W[G.id]===!0)return G;return G.addEventListener("dispose",H),W[G.id]=!0,$.memory.geometries++,G}function X(q){let G=q.attributes;for(let O in G)Q.update(G[O],J.ARRAY_BUFFER)}function U(q){let G=[],O=q.index,L=q.attributes.position,z=0;if(L===void 0)return;if(O!==null){let _=O.array;z=O.version;for(let C=0,V=_.length;C<V;C+=3){let I=_[C+0],w=_[C+1],P=_[C+2];G.push(I,w,w,P,P,I)}}else{let _=L.array;z=L.version;for(let C=0,V=_.length/3-1;C<V;C+=3){let I=C+0,w=C+1,P=C+2;G.push(I,w,w,P,P,I)}}let D=new(L.count>=65535?j6:S6)(G,1);D.version=z;let E=K.get(q);if(E)Q.remove(E);K.set(q,D)}function N(q){let G=K.get(q);if(G){let O=q.index;if(O!==null){if(G.version<O.version)U(q)}}else U(q);return K.get(q)}return{get:Y,update:X,getWireframeAttribute:N}}function HX(J,Q,$){let Z;function W(q){Z=q}let K,H;function Y(q){K=q.type,H=q.bytesPerElement}function X(q,G){J.drawElements(Z,G,K,q*H),$.update(G,Z,1)}function U(q,G,O){if(O===0)return;J.drawElementsInstanced(Z,G,K,q*H,O),$.update(G,Z,O)}function N(q,G,O){if(O===0)return;Q.get("WEBGL_multi_draw").multiDrawElementsWEBGL(Z,G,0,K,q,0,O);let z=0;for(let D=0;D<O;D++)z+=G[D];$.update(z,Z,1)}this.setMode=W,this.setIndex=Y,this.render=X,this.renderInstances=U,this.renderMultiDraw=N}function YX(J){let Q={geometries:0,textures:0},$={frame:0,calls:0,triangles:0,points:0,lines:0};function Z(K,H,Y){switch($.calls++,H){case J.TRIANGLES:$.triangles+=Y*(K/3);break;case J.LINES:$.lines+=Y*(K/2);break;case J.LINE_STRIP:$.lines+=Y*(K-1);break;case J.LINE_LOOP:$.lines+=Y*K;break;case J.POINTS:$.points+=Y*K;break;default:P0("WebGLInfo: Unknown draw mode:",H);break}}function W(){$.calls=0,$.triangles=0,$.points=0,$.lines=0}return{memory:Q,render:$,programs:null,autoReset:!0,reset:W,update:Z}}function XX(J,Q,$){let Z=new WeakMap,W=new KJ;function K(H,Y,X){let U=H.morphTargetInfluences,N=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,q=N!==void 0?N.length:0,G=Z.get(Y);if(G===void 0||G.count!==q){let B=function(){P.dispose(),Z.delete(Y),Y.removeEventListener("dispose",B)};if(G!==void 0)G.texture.dispose();let O=Y.morphAttributes.position!==void 0,L=Y.morphAttributes.normal!==void 0,z=Y.morphAttributes.color!==void 0,D=Y.morphAttributes.position||[],E=Y.morphAttributes.normal||[],_=Y.morphAttributes.color||[],C=0;if(O===!0)C=1;if(L===!0)C=2;if(z===!0)C=3;let V=Y.attributes.position.count*C,I=1;if(V>Q.maxTextureSize)I=Math.ceil(V/Q.maxTextureSize),V=Q.maxTextureSize;let w=new Float32Array(V*I*4*q),P=new P6(w,V,I,q);P.type=q9,P.needsUpdate=!0;let k=C*4;for(let l=0;l<q;l++){let A=D[l],m=E[l],o=_[l],p=V*I*4*l;for(let n=0;n<A.count;n++){let u=n*k;if(O===!0)W.fromBufferAttribute(A,n),w[p+u+0]=W.x,w[p+u+1]=W.y,w[p+u+2]=W.z,w[p+u+3]=0;if(L===!0)W.fromBufferAttribute(m,n),w[p+u+4]=W.x,w[p+u+5]=W.y,w[p+u+6]=W.z,w[p+u+7]=0;if(z===!0)W.fromBufferAttribute(o,n),w[p+u+8]=W.x,w[p+u+9]=W.y,w[p+u+10]=W.z,w[p+u+11]=o.itemSize===4?W.w:1}}G={count:q,texture:P,size:new g0(V,I)},Z.set(Y,G),Y.addEventListener("dispose",B)}if(H.isInstancedMesh===!0&&H.morphTexture!==null)X.getUniforms().setValue(J,"morphTexture",H.morphTexture,$);else{let O=0;for(let z=0;z<U.length;z++)O+=U[z];let L=Y.morphTargetsRelative?1:1-O;X.getUniforms().setValue(J,"morphTargetBaseInfluence",L),X.getUniforms().setValue(J,"morphTargetInfluences",U)}X.getUniforms().setValue(J,"morphTargetsTexture",G.texture,$),X.getUniforms().setValue(J,"morphTargetsTextureSize",G.size)}return{update:K}}function UX(J,Q,$,Z,W){let K=new WeakMap;function H(U){let N=W.render.frame,q=U.geometry,G=Q.get(U,q);if(K.get(G)!==N)Q.update(G),K.set(G,N);if(U.isInstancedMesh){if(U.hasEventListener("dispose",X)===!1)U.addEventListener("dispose",X);if(K.get(U)!==N){if($.update(U.instanceMatrix,J.ARRAY_BUFFER),U.instanceColor!==null)$.update(U.instanceColor,J.ARRAY_BUFFER);K.set(U,N)}}if(U.isSkinnedMesh){let O=U.skeleton;if(K.get(O)!==N)O.update(),K.set(O,N)}return G}function Y(){K=new WeakMap}function X(U){let N=U.target;if(N.removeEventListener("dispose",X),Z.releaseStatesOfObject(N),$.remove(N.instanceMatrix),N.instanceColor!==null)$.remove(N.instanceColor)}return{update:H,dispose:Y}}var GX={[w7]:"LINEAR_TONE_MAPPING",[I7]:"REINHARD_TONE_MAPPING",[A7]:"CINEON_TONE_MAPPING",[C7]:"ACES_FILMIC_TONE_MAPPING",[_7]:"AGX_TONE_MAPPING",[T7]:"NEUTRAL_TONE_MAPPING",[P7]:"CUSTOM_TONE_MAPPING"};function NX(J,Q,$,Z,W,K){let H=new mJ(Q,$,{type:J,depthBuffer:W,stencilBuffer:K,samples:Z?4:0,depthTexture:W?new _9(Q,$):void 0}),Y=new mJ(Q,$,{type:E9,depthBuffer:!1,stencilBuffer:!1}),X=new yJ;X.setAttribute("position",new nJ([-1,3,0,-1,-1,0,3,-1,0],3)),X.setAttribute("uv",new nJ([0,2,0,0,2,0],2));let U=new AQ({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}var WU={[w7]:"Linear",[I7]:"Reinhard",[A7]:"Cineon",[C7]:"ACESFilmic",[_7]:"AgX",[T7]:"Neutral",[P7]:"Custom"};function KU(J,Q){let $=WU[Q];if($===void 0)return C0("WebGLProgram: Unsupported toneMapping:",Q),"vec3 "+J+"( vec3 color ) { return LinearToneMapping( color ); }";return"vec3 "+J+"( vec3 color ) { return "+$+"ToneMapping( color ); }"}var d6=new b;function HU(){h0.getLuminanceCoefficients(d6);let J=d6.x.toFixed(4),Q=d6.y.toFixed(4),$=d6.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${J}, ${Q}, ${$} );`,"\treturn dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`;return Q}var FU={[j8]:"SHADOWMAP_TYPE_PCF",[D8]:"SHADOWMAP_TYPE_VSM"};function OU(J){return FU[J.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var kU={[k8]:"ENVMAP_TYPE_CUBE",[h9]:"ENVMAP_TYPE_CUBE",[v8]:"ENVMAP_TYPE_CUBE_UV"};function RU(J){if(J.envMap===!1)return"ENVMAP_TYPE_CUBE";return kU[J.envMapMode]||"ENVMAP_TYPE_CUBE"}var MU={[h9]:"ENVMAP_MODE_REFRACTION"};function LU(J){if(J.envMap===!1)return"ENVMAP_MODE_REFLECTION";return MU[J.envMapMode]||"ENVMAP_MODE_REFLECTION"}var VU={[UZ]:"ENVMAP_BLENDING_MULTIPLY",[GZ]:"ENVMAP_BLENDING_MIX",[NZ]:"ENVMAP_BLENDING_ADD"};function BU(J){if(J.envMap===!1)return"ENVMAP_BLENDING_NONE";return VU[J.combine]||"ENVMAP_BLENDING_NONE"}function zU(J){let Q=J.envMapCubeUVHeight;if(Q===null)return null;let $=Math.log2(Q)-2,Z=1/Q;return{texelWidth:1/(3*Math.max(Math.pow(2,$),112)),texelHeight:Z,maxMip:$}}function wU(J,Q,$,Z){let W=J.getContext(),K=$.defines,H=$.vertexShader,Y=$.fragmentShader,X=OU($),U=RU($),N=LU($),q=BU($),G=zU($),O=YU($),L=XU(K),z=W.createProgram(),D,E,_=$.glslVersion?"#version "+$.glslVersion+`
...
Program Info Log: `+n+`
`+H0+`
`+M0)}else if(n!=="")C0("WebGLProgram: Program Info Log:",n);else if(u===""||h==="")e=!1;if(e)A.diagnostics={runnable:t,programLog:n,vertexShader:{log:u,prefix:D},fragmentShader:{log:h,prefix:E}}}W.deleteShader(I),W.deleteShader(w),k=new l8(W,z),B=UU(W,z)}let k;this.getUniforms=function(){if(k===void 0)P(this);return k};let B;this.getAttributes=function(){if(B===void 0)P(this);return B};let l=$.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){if(l===!1)l=W.getProgramParameter(z,eX);return l},this.destroy=function(){Z.releaseStatesOfProgram(this),W.deleteProgram(z),this.program=void 0},this.type=$.shaderType,this.name=$.shaderName,this.id=JU++,this.cacheKey=Q,this.usedTimes=1,this.program=z,this.vertexShader=I,this.fragmentShader=w,this}var IU=0;class FW{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(J,Q,$){let Z=this._getShaderCacheForMaterial(J);if(Z.has(Q)===!1)Z.add(Q),Q.usedTimes++;if(Z.has($)===!1)Z.add($),$.usedTimes++;return this}remove(J){let Q=this.materialCache.get(J);for(let $ of Q)if($.usedTimes--,$.usedTimes===0)this.shaderCache.delete($.code);return this.materialCache.delete(J),this}getVertexShaderStage(J){return this._getShaderStage(J.vertexShader)}getFragmentShaderStage(J){return this._getShaderStage(J.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(J){let Q=this.materialCache,$=Q.get(J);if($===void 0)$=new Set,Q.set(J,$);return $}_getShaderStage(J){let Q=this.shaderCache,$=Q.get(J);if($===void 0)$=new OW(J),Q.set(J,$);return $}}class OW{constructor(J){this.id=IU++,this.code=J,this.usedTimes=0}}function AU(J){return J===m9||J===w6||J===I6}function CU(J,Q,$,Z,W,K){let H=new _6,Y=new FW,X=new Set,U=[],N=new Map,q=Z.logarithmicDepthBuffer,G=Z.precision,O={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function L(k){if(X.add(k),k===0)return"uv";return`uv${k}`}function z(k,B,l,A,m,o){let p=A.fog,n=m.geometry,u=k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial?A.environment:null,h=k.isMeshStandardMaterial||k.isMeshLambertMaterial&&!k.envMap||k.isMeshPhongMaterial&&!k.envMap,t=Q.get(k.envMap||u,h),e=!!t&&t.mapping===v8?t.image.height:null,H0=O[k.type];if(k.precision!==null){if(G=Z.getMaxPrecision(k.precision),G!==k.precision)C0("WebGLProgram.getParameters:",k.precision,"not supported, using",G,"instead.")}let M0=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,R0=M0!==void 0?M0.length:0,ZJ=0;if(n.morphAttributes.position!==void 0)ZJ=1;if(n.morphAttributes.normal!==void 0)ZJ=2;if(n.morphAttributes.color!==void 0)ZJ=3;let i0,i,Z0,D0;if(H0){let T0=$9[H0];i0=T0.vertexShader,i=T0.fragmentShader}else{i0=k.vertexShader,i=k.fragmentShader;let T0=Y.getVertexShaderStage(k),HJ=Y.getFragmentShaderStage(k);Y.update(k,T0,HJ),Z0=T0.id,D0=HJ.id}let F0=J.getRenderTarget(),A0=J.state.buffers.depth.getReversed(),p0=m.isInstancedMesh===!0,v0=m.isBatchedMesh===!0,f0=!!k.map,t0=!!k.matcap,m0=!!t,b0=!!k.aoMap,FJ=!!k.lightMap,bJ=!!k.bumpMap&&k.wireframe===!1,QJ=!!k.normalMap,RJ=!!k.displacementMap,OJ=!!k.emissiveMap,qJ=!!k.metalnessMap,j=!!k.roughnessMap,hJ=k.anisotropy>0,c0=k.clearcoat>0,$J=k.dispersion>0,M=k.iridescence>0,F=k.sheen>0,T=k.transmission>0,g=hJ&&!!k.anisotropyMap,r=c0&&!!k.clearcoatMap,J0=c0&&!!k.clearcoatNormalMap,Y0=c0&&!!k.clearcoatRoughnessMap,d=M&&!!k.iridescenceMap,s=M&&!!k.iridescenceThicknessMap,q0=F&&!!k.sheenColorMap,V0=F&&!!k.sheenRoughnessMap,X0=!!k.specularMap,Q0=!!k.specularColorMap,w0=!!k.specularIntensityMap,I0=T&&!!k.transmissionMap,u0=T&&!!k.thicknessMap,S=!!k.gradientMap,$0=!!k.alphaMap,c=k.alphaTest>0,W0=!!k.alphaHash,E0=!!k.extensions,a=sJ;if(k.toneMapped){if(F0===null||F0.isXRRenderTarget===!0)a=J.toneMapping}let K0={shaderID:H0,shaderType:k.type,shaderName:k.name,vertexShader:i0,fragmentShader:i,defines:k.defines,customVertexShaderID:Z0,customFragmentShaderID:D0,isRawShaderMaterial:k.isRawShaderMaterial===!0,glslVersion:k.glslVersion,precision:G,batching:v0,batchingColor:v0&&m._colorsTexture!==null,instancing:p0,instancingColor:p0&&m.instanceColor!==null,instancingMorph:p0&&m.morphTexture!==null,outputColorSpace:F0===null?J.outputColorSpace:F0.isXRRenderTarget===!0?F0.texture.colorSpace:h0.workingColorSpace,alphaToCoverage:!!k.alphaToCoverage,map:f0,matcap:t0,envMap:m0,envMapMode:m0&&t.mapping,envMapCubeUVHeight:e,aoMap:b0,lightMap:FJ,bumpMap:bJ,normalMap:QJ,displacementMap:RJ,emissiveMap:OJ,normalMapObjectSpace:QJ&&k.normalMapType===BZ,normalMapTangentSpace:QJ&&k.normalMapType===EQ,packedNormalMap:QJ&&k.normalMapType===EQ&&AU(k.normalMap.format),metalnessMap:qJ,roughnessMap:j,anisotropy:hJ,anisotropyMap:g,clearcoat:c0,clearcoatMap:r,clearcoatNormalMap:J0,clearcoatRoughnessMap:Y0,dispersion:$J,iridescence:M,iridescenceMap:d,iridescenceThicknessMap:s,sheen:F,sheenColorMap:q0,sheenRoughnessMap:V0,specularMap:X0,specularColorMap:Q0,specularIntensityMap:w0,transmission:T,transmissionMap:I0,thicknessMap:u0,gradientMap:S,opaque:k.transparent===!1&&k.blending===y8&&k.alphaToCoverage===!1,alphaMap:$0,alphaTest:c,alphaHash:W0,combine:k.combine,mapUv:f0&&L(k.map.channel),aoMapUv:b0&&L(k.aoMap.channel),lightMapUv:FJ&&L(k.lightMap.channel),bumpMapUv:bJ&&L(k.bumpMap.channel),normalMapUv:QJ&&L(k.normalMap.channel),displacementMapUv:RJ&&L(k.displacementMap.channel),emissiveMapUv:OJ&&L(k.emissiveMap.channel),metalnessMapUv:qJ&&L(k.metalnessMap.channel),roughnessMapUv:j&&L(k.roughnessMap.channel),anisotropyMapUv:g&&L(k.anisotropyMap.channel),clearcoatMapUv:r&&L(k.clearcoatMap.channel),clearcoatNormalMapUv:J0&&L(k.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Y0&&L(k.clearcoatRoughnessMap.channel),iridescenceMapUv:d&&L(k.iridescenceMap.channel),iridescenceThicknessMapUv:s&&L(k.iridescenceThicknessMap.channel),sheenColorMapUv:q0&&L(k.sheenColorMap.channel),sheenRoughnessMapUv:V0&&L(k.sheenRoughnessMap.channel),specularMapUv:X0&&L(k.specularMap.channel),specularColorMapUv:Q0&&L(k.specularColorMap.channel),specularIntensityMapUv:w0&&L(k.specularIntensityMap.channel),transmissionMapUv:I0&&L(k.transmissionMap.channel),thicknessMapUv:u0&&L(k.thicknessMap.channel),alphaMapUv:$0&&L(k.alphaMap.channel),vertexTangents:!!n.attributes.tangent&&(QJ||hJ),vertexNormals:!!n.attributes.normal,vertexColors:k.vertexColors,vertexAlphas:k.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,pointsUvs:m.isPoints===!0&&!!n.attributes.uv&&(f0||$0),fog:!!p,useFog:k.fog===!0,fogExp2:!!p&&p.isFogExp2,flatShading:k.wireframe===!1&&(k.flatShading===!0||n.attributes.normal===void 0&&QJ===!1&&(k.isMeshLambertMaterial||k.isMeshPhongMaterial||k.isMeshStandardMaterial||k.isMeshPhysicalMaterial)),sizeAttenuation:k.sizeAttenuation===!0,logarithmicDepthBuffer:q,reversedDepthBuffer:A0,skinning:m.isSkinnedMesh===!0,hasPositionAttribute:n.attributes.position!==void 0,morphTargets:n.morphAttributes.position!==void 0,morphNormals:n.morphAttributes.normal!==void 0,morphColors:n.morphAttributes.color!==void 0,morphTargetsCount:R0,morphTextureStride:ZJ,numDirLights:B.directional.length,numPointLights:B.point.length,numSpotLights:B.spot.length,numSpotLightMaps:B.spotLightMap.length,numRectAreaLights:B.rectArea.length,numHemiLights:B.hemi.length,numDirLightShadows:B.directionalShadowMap.length,numPointLightShadows:B.pointShadowMap.length,numSpotLightShadows:B.spotShadowMap.length,numSpotLightShadowsWithMaps:B.numSpotLightShadowsWithMaps,numLightProbes:B.numLightProbes,numLightProbeGrids:o.length,numClippingPlanes:K.numPlanes,numClipIntersection:K.numIntersection,dithering:k.dithering,shadowMapEnabled:J.shadowMap.enabled&&l.length>0,shadowMapType:J.shadowMap.type,toneMapping:a,decodeVideoTexture:f0&&k.map.isVideoTexture===!0&&h0.getTransfer(k.map.colorSpace)===r0,decodeVideoTextureEmissive:OJ&&k.emissiveMap.isVideoTexture===!0&&h0.getTransfer(k.emissiveMap.colorSpace)===r0,premultipliedAlpha:k.premultipliedAlpha,doubleSided:k.side===tJ,flipSided:k.side===CJ,useDepthPacking:k.depthPacking>=0,depthPacking:k.depthPacking||0,index0AttributeName:k.index0AttributeName,extensionClipCullDistance:E0&&k.extensions.clipCullDistance===!0&&$.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(E0&&k.extensions.multiDraw===!0||v0)&&$.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:$.has("KHR_parallel_shader_compile"),customProgramCacheKey:k.customProgramCacheKey()};return K0.vertexUv1s=X.has(1),K0.vertexUv2s=X.has(2),K0.vertexUv3s=X.has(3),X.clear(),K0}function D(k){let B=[];if(k.shaderID)B.push(k.shaderID);else B.push(k.customVertexShaderID),B.push(k.customFragmentShaderID);if(k.defines!==void 0)for(let l in k.defines)B.push(l),B.push(k.defines[l]);if(k.isRawShaderMaterial===!1)E(B,k),_(B,k),B.push(J.outputColorSpace);return B.push(k.customProgramCacheKey),B.join()}function E(k,B){k.push(B.precision),k.push(B.outputColorSpace),k.push(B.envMapMode),k.push(B.envMapCubeUVHeight),k.push(B.mapUv),k.push(B.alphaMapUv),k.push(B.lightMapUv),k.push(B.aoMapUv),k.push(B.bumpMapUv),k.push(B.normalMapUv),k.push(B.displacementMapUv),k.push(B.emissiveMapUv),k.push(B.metalnessMapUv),k.push(B.roughnessMapUv),k.push(B.anisotropyMapUv),k.push(B.clearcoatMapUv),k.push(B.clearcoatNormalMapUv),k.push(B.clearcoatRoughnessMapUv),k.push(B.iridescenceMapUv),k.push(B.iridescenceThicknessMapUv),k.push(B.sheenColorMapUv),k.push(B.sheenRoughnessMapUv),k.push(B.specularMapUv),k.push(B.specularColorMapUv),k.push(B.specularIntensityMapUv),k.push(B.transmissionMapUv),k.push(B.thicknessMapUv),k.push(B.combine),k.push(B.fogExp2),k.push(B.sizeAttenuation),k.push(B.morphTargetsCount),k.push(B.morphAttributeCount),k.push(B.numDirLights),k.push(B.numPointLights),k.push(B.numSpotLights),k.push(B.numSpotLightMaps),k.push(B.numHemiLights),k.push(B.numRectAreaLights),k.push(B.numDirLightShadows),k.push(B.numPointLightShadows),k.push(B.numSpotLightShadows),k.push(B.numSpotLightShadowsWithMaps),k.push(B.numLightProbes),k.push(B.shadowMapType),k.push(B.toneMapping),k.push(B.numClippingPlanes),k.push(B.numClipIntersection),k.push(B.depthPacking)}function _(k,B){if(H.disableAll(),B.instancing)H.enable(0);if(B.instancingColor)H.enable(1);if(B.instancingMorph)H.enable(2);if(B.matcap)H.enable(3);if(B.envMap)H.enable(4);if(B.normalMapObjectSpace)H.enable(5);if(B.normalMapTangentSpace)H.enable(6);if(B.clearcoat)H.enable(7);if(B.iridescence)H.enable(8);if(B.alphaTest)H.enable(9);if(B.vertexColors)H.enable(10);if(B.vertexAlphas)H.enable(11);if(B.vertexUv1s)H.enable(12);if(B.vertexUv2s)H.enable(13);if(B.vertexUv3s)H.enable(14);if(B.vertexTangents)H.enable(15);if(B.anisotropy)H.enable(16);if(B.alphaHash)H.enable(17);if(B.batching)H.enable(18);if(B.dispersion)H.enable(19);if(B.batchingColor)H.enable(20);if(B.gradientMap)H.enable(21);if(B.packedNormalMap)H.enable(22);if(B.vertexNormals)H.enable(23);if(k.push(H.mask),H.disableAll(),B.fog)H.enable(0);if(B.useFog)H.enable(1);if(B.flatShading)H.enable(2);if(B.logarithmicDepthBuffer)H.enable(3);if(B.reversedDepthBuffer)H.enable(4);if(B.skinning)H.enable(5);if(B.morphTargets)H.enable(6);if(B.morphNormals)H.enable(7);if(B.morphColors)H.enable(8);if(B.premultipliedAlpha)H.enable(9);if(B.shadowMapEnabled)H.enable(10);if(B.doubleSided)H.enable(11);if(B.flipSided)H.enable(12);if(B.useDepthPacking)H.enable(13);if(B.dithering)H.enable(14);if(B.transmission)H.enable(15);if(B.sheen)H.enable(16);if(B.opaque)H.enable(17);if(B.pointsUvs)H.enable(18);if(B.decodeVideoTexture)H.enable(19);if(B.decodeVideoTextureEmissive)H.enable(20);if(B.alphaToCoverage)H.enable(21);if(B.numLightProbeGrids>0)H.enable(22);if(B.hasPositionAttribute)H.enable(23);k.push(H.mask)}function C(k){let B=O[k.type],l;if(B){let A=$9[B];l=fZ.clone(A.uniforms)}else l=k.uniforms;return l}function V(k,B){let l=N.get(B);if(l!==void 0)++l.usedTimes;else l=new wU(J,B,k,W),U.push(l),N.set(B,l);return l}function I(k){if(--k.usedTimes===0){let B=U.indexOf(k);U[B]=U[U.length-1],U.pop(),N.delete(k.cacheKey),k.destroy()}}function w(k){Y.remove(k)}function P(){Y.dispose()}return{getParameters:z,getProgramCacheKey:D,getUniforms:C,acquireProgram:V,releaseProgram:I,releaseShaderCache:w,programs:U,dispose:P}}function PU(){let J=new WeakMap;function Q(H){return J.has(H)}function $(H){let Y=J.get(H);if(Y===void 0)Y={},J.set(H,Y);return Y}function Z(H){J.delete(H)}function W(H,Y,X){J.get(H)[Y]=X}function K(){J=new WeakMap}return{has:Q,get:$,remove:Z,update:W,dispose:K}}function _U(J,Q){if(J.groupOrder!==Q.groupOrder)return J.groupOrder-Q.groupOrder;else if(J.renderOrder!==Q.renderOrder)return J.renderOrder-Q.renderOrder;else if(J.material.id!==Q.material.id)return J.material.id-Q.material.id;else if(J.materialVariant!==Q.materialVariant)return J.materialVariant-Q.materialVariant;else if(J.z!==Q.z)return J.z-Q.z;else return J.id-Q.id}function $W(J,Q){if(J.groupOrder!==Q.groupOrder)return J.groupOrder-Q.groupOrder;else if(J.renderOrder!==Q.renderOrder)return J.renderOrder-Q.renderOrder;else if(J.z!==Q.z)return Q.z-J.z;else return J.id-Q.id}function ZW(){let J=[],Q=0,$=[],Z=[],W=[];function K(){Q=0,$.length=0,Z.length=0,W.length=0}function H(G){let O=0;if(G.isInstancedMesh)O+=2;if(G.isSkinnedMesh)O+=1;return O}function Y(G,O,L,z,D,E){let _=J[Q];if(_===void 0)_={id:G.id,object:G,geometry:O,material:L,materialVariant:H(G),groupOrder:z,renderOrder:G.renderOrder,z:D,group:E},J[Q]=_;else _.id=G.id,_.object=G,_.geometry=O,_.material=L,_.materialVariant=H(G),_.groupOrder=z,_.renderOrder=G.renderOrder,_.z=D,_.group=E;return Q++,_}function X(G,O,L,z,D,E){let _=Y(G,O,L,z,D,E);if(L.transmission>0)Z.push(_);else if(L.transparent===!0)W.push(_);else $.push(_)}function U(G,O,L,z,D,E){let _=Y(G,O,L,z,D,E);if(L.transmission>0)Z.unshift(_);else if(L.transparent===!0)W.unshift(_);else $.unshift(_)}function N(G,O,L){if($.length>1)$.sort(G||_U);if(Z.length>1)Z.sort(O||$W);if(W.length>1)W.sort(O||$W);if(L)$.reverse(),Z.reverse(),W.reverse()}function q(){for(let G=Q,O=J.length;G<O;G++){let L=J[G];if(L.id===null)break;L.id=null,L.object=null,L.geometry=null,L.material=null,L.group=null}}return{opaque:$,transmissive:Z,transparent:W,init:K,push:X,unshift:U,finish:q,sort:N}}function TU(){let J=new WeakMap;function Q(Z,W){let K=J.get(Z),H;if(K===void 0)H=new ZW,J.set(Z,[H]);else if(W>=K.length)H=new ZW,K.push(H);else H=K[W];return H}function $(){J=new WeakMap}return{get:Q,dispose:$}}function SU(){let J={};return{get:function(Q){if(J[Q.id]!==void 0)return J[Q.id];let $;switch(Q.type){case"DirectionalLight":$={direction:new b,color:new l0};break;case"SpotLight":$={position:new b,direction:new b,color:new l0,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":$={position:new b,color:new l0,distance:0,decay:0};break;case"HemisphereLight":$={direction:new b,skyColor:new l0,groundColor:new l0};break;case"RectAreaLight":$={color:new l0,position:new b,halfWidth:new b,halfHeight:new b};break}return J[Q.id]=$,$}}}function jU(){let J={};return{get:function(Q){if(J[Q.id]!==void 0)return J[Q.id];let $;switch(Q.type){case"DirectionalLight":$={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new g0};break;case"SpotLight":$={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new g0};break;case"PointLight":$={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new g0,shadowCameraNear:1,shadowCameraFar:1000};break}return J[Q.id]=$,$}}}var yU=0;function vU(J,Q){return(Q.castShadow?2:0)-(J.castShadow?2:0)+(Q.map?1:0)-(J.map?1:0)}function fU(J){let Q=new SU,$=jU(),Z={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let U=0;U<9;U++)Z.probe.push(new b);let W=new b,K=new WJ,H=new WJ;function Y(U){let N=0,q=0,G=0;for(let B=0;B<9;B++)Z.probe[B].set(0,0,0);let O=0,L=0,z=0,D=0,E=0,_=0,C=0,V=0,I=0,w=0,P=0;U.sort(vU);for(let B=0,l=U.length;B<l;B++){let A=U[B],m=A.color,o=A.intensity,p=A.distance,n=null;if(A.shadow&&A.shadow.map)if(A.shadow.map.texture.format===m9)n=A.shadow.map.texture;else n=A.shadow.map.depthTexture||A.shadow.map.texture;if(A.isAmbientLight)N+=m.r*o,q+=m.g*o,G+=m.b*o;else if(A.isLightProbe){for(let u=0;u<9;u++)Z.probe[u].addScaledVector(A.sh.coefficients[u],o);P++}else if(A.isDirectionalLight){let u=Q.get(A);if(u.color.copy(A.color).multiplyScalar(A.intensity),A.castShadow){let h=A.shadow,t=$.get(A);t.shadowIntensity=h.intensity,t.shadowBias=h.bias,t.shadowNormalBias=h.normalBias,t.shadowRadius=h.radius,t.shadowMapSize=h.mapSize,Z.directionalShadow[O]=t,Z.directionalShadowMap[O]=n,Z.directionalShadowMatrix[O]=A.shadow.matrix,_++}Z.directional[O]=u,O++}else if(A.isSpotLight){let u=Q.get(A);u.position.setFromMatrixPosition(A.matrixWorld),u.color.copy(m).multiplyScalar(o),u.distance=p,u.coneCos=Math.cos(A.angle),u.penumbraCos=Math.cos(A.angle*(1-A.penumbra)),u.decay=A.decay,Z.spot[z]=u;let h=A.shadow;if(A.map){if(Z.spotLightMap[I]=A.map,I++,h.updateMatrices(A),A.castShadow)w++}if(Z.spotLightMatrix[z]=h.matrix,A.castShadow){let t=$.get(A);t.shadowIntensity=h.intensity,t.shadowBias=h.bias,t.shadowNormalBias=h.normalBias,t.shadowRadius=h.radius,t.shadowMapSize=h.mapSize,Z.spotShadow[z]=t,Z.spotShadowMap[z]=n,V++}z++}else if(A.isRectAreaLight){let u=Q.get(A);u.color.copy(m).multiplyScalar(o),u.halfWidth.set(A.width*0.5,0,0),u.halfHeight.set(0,A.height*0.5,0),Z.rectArea[D]=u,D++}else if(A.isPointLight){let u=Q.get(A);if(u.color.copy(A.color).multiplyScalar(A.intensity),u.distance=A.distance,u.decay=A.decay,A.castShadow){let h=A.shadow,t=$.get(A);t.shadowIntensity=h.intensity,t.shadowBias=h.bias,t.shadowNormalBias=h.normalBias,t.shadowRadius=h.radius,t.shadowMapSize=h.mapSize,t.shadowCameraNear=h.camera.near,t.shadowCameraFar=h.camera.far,Z.pointShadow[L]=t,Z.pointShadowMap[L]=n,Z.pointShadowMatrix[L]=A.shadow.matrix,C++}Z.point[L]=u,L++}else if(A.isHemisphereLight){let u=Q.get(A);u.skyColor.copy(A.color).multiplyScalar(o),u.groundColor.copy(A.groundColor).multiplyScalar(o),Z.hemi[E]=u,E++}}if(D>0)if(J.has("OES_texture_float_linear")===!0)Z.rectAreaLTC1=U0.LTC_FLOAT_1,Z.rectAreaLTC2=U0.LTC_FLOAT_2;else Z.rectAreaLTC1=U0.LTC_HALF_1,Z.rectAreaLTC2=U0.LTC_HALF_2;Z.ambient[0]=N,Z.ambient[1]=q,Z.ambient[2]=G;let k=Z.hash;if(k.directionalLength!==O||k.pointLength!==L||k.spotLength!==z||k.rectAreaLength!==D||k.hemiLength!==E||k.numDirectionalShadows!==_||k.numPointShadows!==C||k.numSpotShadows!==V||k.numSpotMaps!==I||k.numLightProbes!==P)Z.directional.length=O,Z.spot.length=z,Z.rectArea.length=D,Z.point.length=L,Z.hemi.length=E,Z.directionalShadow.length=_,Z.directionalShadowMap.length=_,Z.pointShadow.length=C,Z.pointShadowMap.length=C,Z.spotShadow.length=V,Z.spotShadowMap.length=V,Z.directionalShadowMatrix.length=_,Z.pointShadowMatrix.length=C,Z.spotLightMatrix.length=V+I-w,Z.spotLightMap.length=I,Z.numSpotLightShadowsWithMaps=w,Z.numLightProbes=P,k.directionalLength=O,k.pointLength=L,k.spotLength=z,k.rectAreaLength=D,k.hemiLength=E,k.numDirectionalShadows=_,k.numPointShadows=C,k.numSpotShadows=V,k.numSpotMaps=I,k.numLightProbes=P,Z.version=yU++}function X(U,N){let q=0,G=0,O=0,L=0,z=0,D=N.matrixWorldInverse;for(let E=0,_=U.length;E<_;E++){let C=U[E];if(C.isDirectionalLight){let V=Z.directional[q];V.direction.setFromMatrixPosition(C.matrixWorld),W.setFromMatrixPosition(C.target.matrixWorld),V.direction.sub(W),V.direction.transformDirection(D),q++}else if(C.isSpotLight){let V=Z.spot[O];V.position.setFromMatrixPosition(C.matrixWorld),V.position.applyMatrix4(D),V.direction.setFromMatrixPosition(C.matrixWorld),W.setFromMatrixPosition(C.target.matrixWorld),V.direction.sub(W),V.direction.transformDirection(D),O++}else if(C.isRectAreaLight){let V=Z.rectArea[L];V.position.setFromMatrixPosition(C.matrixWorld),V.position.applyMatrix4(D),H.identity(),K.copy(C.matrixWorld),K.premultiply(D),H.extractRotation(K),V.halfWidth.set(C.width*0.5,0,0),V.halfHeight.set(0,C.height*0.5,0),V.halfWidth.applyMatrix4(H),V.halfHeight.applyMatrix4(H),L++}else if(C.isPointLight){let V=Z.point[G];V.position.setFromMatrixPosition(C.matrixWorld),V.position.applyMatrix4(D),G++}else if(C.isHemisphereLight){let V=Z.hemi[z];V.direction.setFromMatrixPosition(C.matrixWorld),V.direction.transformDirection(D),z++}}}return{setup:Y,setupView:X,state:Z}}function WW(J){let Q=new fU(J),$=[],Z=[],W=[];function K(G){q.camera=G,$.length=0,Z.length=0,W.length=0}function H(G){$.push(G)}function Y(G){Z.push(G)}function X(G){W.push(G)}function U(){Q.setup($)}function N(G){Q.setupView($,G)}let q={lightsArray:$,shadowsArray:Z,lightProbeGridArray:W,camera:null,lights:Q,transmissionRenderTarget:{},textureUnits:0};return{init:K,state:q,setupLights:U,setupLightsView:N,pushLight:H,pushShadow:Y,pushLightProbeGrid:X}}function bU(J){let Q=new WeakMap;function $(W,K=0){let H=Q.get(W),Y;if(H===void 0)Y=new WW(J),Q.set(W,[Y]);else if(K>=H.length)Y=new WW(J),H.push(Y);else Y=H[K];return Y}function Z(){Q=new WeakMap}return{get:$,dispose:Z}}var hU=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,gU=[new b(1,0,0),new b(-1,0,0),new b(0,1,0),new b(0,-1,0),new b(0,0,1),new b(0,0,-1)],pU=[new b(0,-1,0),new b(0,-1,0),new b(0,0,1),new b(0,0,-1),new b(0,-1,0),new b(0,-1,0)],KW=new WJ,m8=new b,aQ=new b;function mU(J,Q,$){let Z=new f6,W=new g0,K=new g0,H=new KJ,Y=new CQ,X=new PQ,U={},N=$.maxTextureSize,q={[F8]:CJ,[CJ]:F8,[tJ]:tJ},G=new IJ({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new g0},radius:{value:4}},vertexShader:hU,fragmentShader:xU}),O=G.clone();O.defines.HORIZONTAL_PASS=1;let L=new yJ;L.setAttribute("position",new NJ(new Float32Array([-1,-1,0.5,3,-1,0.5,-1,3,0.5]),3));let z=new vJ(L,G),D=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=j8;let E=this.type;this.render=function(w,P,k){if(D.enabled===!1)return;if(D.autoUpdate===!1&&D.needsUpdate===!1)return;if(w.length===0)return;if(this.type===f$)C0("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=j8;let B=J.getRenderTarget(),l=J.getActiveCubeFace(),A=J.getActiveMipmapLevel(),m=J.state;if(m.setBlending(eJ),m.buffers.depth.getReversed()===!0)m.buffers.color.setClear(0,0,0,0);else m.buffers.color.setClear(1,1,1,1);m.buffers.depth.setTest(!0),m.setScissorTest(!1);let o=E!==this.type;if(o)P.traverse(function(p){if(p.material)if(Array.isArray(p.material))p.material.forEach((n)=>n.needsUpdate=!0);else p.material.needsUpdate=!0});for(let p=0,n=w.length;p<n;p++){let u=w[p],h=u.shadow;if(h===void 0){C0("WebGLShadowMap:",u,"has no shadow.");continue}if(h.autoUpdate===!1&&h.needsUpdate===!1)continue;W.copy(h.mapSize);let t=h.getFrameExtents();if(W.multiply(t),K.copy(h.mapSize),W.x>N||W.y>N){if(W.x>N)K.x=Math.floor(N/t.x),W.x=K.x*t.x,h.mapSize.x=K.x;if(W.y>N)K.y=Math.floor(N/t.y),W.y=K.y*t.y,h.mapSize.y=K.y}let e=J.state.buffers.depth.getReversed();if(h.camera._reversedDepth=e,h.map===null||o===!0){if(h.map!==null){if(h.map.depthTexture!==null)h.map.depthTexture.dispose(),h.map.depthTexture=null;h.map.dispose()}if(this.type===D8){if(u.isPointLight){C0("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}h.map=new mJ(W.x,W.y,{format:m9,type:E9,minFilter:PJ,magFilter:PJ,generateMipmaps:!1}),h.map.texture.name=u.name+".shadowMap",h.map.depthTexture=new _9(W.x,W.y,q9),h.map.depthTexture.name=u.name+".shadowMapDepth",h.map.depthTexture.format=g9,h.map.depthTexture.compareFunction=null,h.map.depthTexture.minFilter=C9,h.map.depthTexture.magFilter=C9}else{if(u.isPointLight)h.map=new J$(W.x),h.map.depthTexture=new wQ(W.x,P9);else h.map=new mJ(W.x,W.y),h.map.depthTexture=new _9(W.x,W.y,P9);if(h.map.depthTexture.name=u.name+".shadowMap",h.map.depthTexture.format=g9,this.type===j8)h.map.depthTexture.compareFunction=e?C6:A6,h.map.depthTexture.minFilter=PJ,h.map.depthTexture.magFilter=PJ;else h.map.depthTexture.compareFunction=null,h.map.depthTexture.minFilter=C9,h.map.depthTexture.magFilter=C9}h.camera.updateProjectionMatrix()}let H0=h.map.isWebGLCubeRenderTarget?6:1;for(let M0=0;M0<H0;M0++){if(h.map.isWebGLCubeRenderTarget)J.setRenderTarget(h.map,M0),J.clear();else{if(M0===0)J.setRenderTarget(h.map),J.clear();let R0=h.getViewport(M0);H.set(K.x*R0.x,K.y*R0.y,K.x*R0.z,K.y*R0.w),m.viewport(H)}if(u.isPointLight){let{camera:R0,matrix:ZJ}=h,i0=u.distance||R0.far;if(i0!==R0.far)R0.far=i0,R0.updateProjectionMatrix();m8.setFromMatrixPosition(u.matrixWorld),R0.position.copy(m8),aQ.copy(R0.position),aQ.add(gU[M0]),R0.up.copy(pU[M0]),R0.lookAt(aQ),R0.updateMatrixWorld(),ZJ.makeTranslation(-m8.x,-m8.y,-m8.z),KW.multiplyMatrices(R0.projectionMatrix,R0.matrixWorldInverse),h._frustum.setFromProjectionMatrix(KW,R0.coordinateSystem,R0.reversedDepth)}else h.updateMatrices(u);Z=h.getFrustum(),V(P,k,h.camera,u,this.type)}if(h.isPointLightShadow!==!0&&this.type===D8)_(h,k);h.needsUpdate=!1}E=this.type,D.needsUpdate=!1,J.setRenderTarget(B,l,A)};function _(w,P){let k=Q.update(z);if(G.defines.VSM_SAMPLES!==w.blurSamples)G.defines.VSM_SAMPLES=w.blurSamples,O.defines.VSM_SAMPLES=w.blurSamples,G.needsUpdate=!0,O.needsUpdate=!0;if(w.mapPass===null)w.mapPass=new mJ(W.x,W.y,{format:m9,type:E9});G.uniforms.shadow_pass.value=w.map.depthTexture,G.uniforms.resolution.value=w.mapSize,G.uniforms.radius.value=w.radius,J.setRenderTarget(w.mapPass),J.clear(),J.renderBufferDirect(P,null,k,G,z,null),O.uniforms.shadow_pass.value=w.mapPass.texture,O.uniforms.resolution.value=w.mapSize,O.uniforms.radius.value=w.radius,J.setRenderTarget(w.map),J.clear(),J.renderBufferDirect(P,null,k,O,z,null)}function C(w,P,k,B){let l=null,A=k.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(A!==void 0)l=A;else if(l=k.isPointLight===!0?X:Y,J.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){let m=l.uuid,o=P.uuid,p=U[m];if(p===void 0)p={},U[m]=p;let n=p[o];if(n===void 0)n=l.clone(),p[o]=n,P.addEventListener("dispose",I);l=n}if(l.visible=P.visible,l.wireframe=P.wireframe,B===D8)l.side=P.shadowSide!==null?P.shadowSide:P.side;else l.side=P.shadowSide!==null?P.shadowSide:q[P.side];if(l.alphaMap=P.alphaMap,l.alphaTest=P.alphaToCoverage===!0?0.5:P.alphaTest,l.map=P.map,l.clipShadows=P.clipShadows,l.clippingPlanes=P.clippingPlanes,l.clipIntersection=P.clipIntersection,l.displacementMap=P.displacementMap,l.displacementScale=P.displacementScale,l.displacementBias=P.displacementBias,l.wireframeLinewidth=P.wireframeLinewidth,l.linewidth=P.linewidth,k.isPointLight===!0&&l.isMeshDistanceMaterial===!0){let m=J.properties.get(l);m.light=k}return l}function V(w,P,k,B,l){if(w.visible===!1)return;if(w.layers.test(P.layers)&&(w.isMesh||w.isLine||w.isPoints)){if((w.castShadow||w.receiveShadow&&l===D8)&&(!w.frustumCulled||Z.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,w.matrixWorld);let o=Q.update(w),p=w.material;if(Array.isArray(p)){let n=o.groups;for(let u=0,h=n.length;u<h;u++){let t=n[u],e=p[t.materialIndex];if(e&&e.visible){let H0=C(w,e,B,l);w.onBeforeShadow(J,w,P,k,o,H0,t),J.renderBufferDirect(k,null,o,H0,w,t),w.onAfterShadow(J,w,P,k,o,H0,t)}}}else if(p.visible){let n=C(w,p,B,l);w.onBeforeShadow(J,w,P,k,o,n,null),J.renderBufferDirect(k,null,o,n,w,null),w.onAfterShadow(J,w,P,k,o,n,null)}}}let m=w.children;for(let o=0,p=m.length;o<p;o++)V(m[o],P,k,B,l)}function I(w){w.target.removeEventListener("dispose",I);for(let k in U){let B=U[k],l=w.target.uuid;if(l in B)B[l].dispose(),delete B[l]}}}function dU(J,Q){function $(){let S=!1,$0=new KJ,c=null,W0=new KJ(0,0,0,0);return{setMask:function(E0){if(c!==E0&&!S)J.colorMask(E0,E0,E0,E0),c=E0},setLocked:function(E0){S=E0},setClear:function(E0,a,K0,T0,HJ){if(HJ===!0)E0*=T0,a*=T0,K0*=T0;if($0.set(E0,a,K0,T0),W0.equals($0)===!1)J.clearColor(E0,a,K0,T0),W0.copy($0)},reset:function(){S=!1,c=null,W0.set(-1,0,0,0)}}}function Z(){let S=!1,$0=!1,c=null,W0=null,E0=null;return{setReversed:function(a){if($0!==a){let K0=Q.get("EXT_clip_control");if(a)K0.clipControlEXT(K0.LOWER_LEFT_EXT,K0.ZERO_TO_ONE_EXT);else K0.clipControlEXT(K0.LOWER_LEFT_EXT,K0.NEGATIVE_ONE_TO_ONE_EXT);$0=a;let T0=E0;E0=null,this.setClear(T0)}},getReversed:function(){return $0},setTest:function(a){if(a)F0(J.DEPTH_TEST);else A0(J.DEPTH_TEST)},setMask:function(a){if(c!==a&&!S)J.depthMask(a),c=a},setFunc:function(a){if($0)a=yZ[a];if(W0!==a){switch(a){case $Z:J.depthFunc(J.NEVER);break;case ZZ:J.depthFunc(J.ALWAYS);break;case WZ:J.depthFunc(J.LESS);break;case z7:J.depthFunc(J.LEQUAL);break;case KZ:J.depthFunc(J.EQUAL);break;case HZ:J.depthFunc(J.GEQUAL);break;case YZ:J.depthFunc(J.GREATER);break;case XZ:J.depthFunc(J.NOTEQUAL);break;default:J.depthFunc(J.LEQUAL)}W0=a}},setLocked:function(a){S=a},setClear:function(a){if(E0!==a){if(E0=a,$0)a=1-a;J.clearDepth(a)}},reset:function(){S=!1,c=null,W0=null,E0=null,$0=!1}}}function W(){let S=!1,$0=null,c=null,W0=null,E0=null,a=null,K0=null,T0=null,HJ=null;return{setTest:function(e0){if(!S)if(e0)F0(J.STENCIL_TEST);else A0(J.STENCIL_TEST)},setMask:function(e0){if($0!==e0&&!S)J.stencilMask(e0),$0=e0},setFunc:function(e0,oJ,W9){if(c!==e0||W0!==oJ||E0!==W9)J.stencilFunc(e0,oJ,W9),c=e0,W0=oJ,E0=W9},setOp:function(e0,oJ,W9){if(a!==e0||K0!==oJ||T0!==W9)J.stencilOp(e0,oJ,W9),a=e0,K0=oJ,T0=W9},setLocked:function(e0){S=e0},setClear:function(e0){if(HJ!==e0)J.clearStencil(e0),HJ=e0},reset:function(){S=!1,$0=null,c=null,W0=null,E0=null,a=null,K0=null,T0=null,HJ=null}}}let K=new $,H=new Z,Y=new W,X=new WeakMap,U=new WeakMap,N={},q={},G={},O=new WeakMap,L=[],z=null,D=!1,E=null,_=null,C=null,V=null,I=null,w=null,P=null,k=new l0(0,0,0),B=0,l=!1,A=null,m=null,o=null,p=null,n=null,u=J.getParameter(J.MAX_COMBINED_TEXTURE_IMAGE_UNITS),h=!1,t=0,e=J.getParameter(J.VERSION);if(e.indexOf("WebGL")!==-1)t=parseFloat(/^WebGL (\d)/.exec(e)[1]),h=t>=1;else if(e.indexOf("OpenGL ES")!==-1)t=parseFloat(/^OpenGL ES (\d)/.exec(e)[1]),h=t>=2;let H0=null,M0={},R0=J.getParameter(J.SCISSOR_BOX),ZJ=J.getParameter(J.VIEWPORT),i0=new KJ().fromArray(R0),i=new KJ().fromArray(ZJ);function Z0(S,$0,c,W0){let E0=new Uint8Array(4),a=J.createTexture();J.bindTexture(S,a),J.texParameteri(S,J.TEXTURE_MIN_FILTER,J.NEAREST),J.texParameteri(S,J.TEXTURE_MAG_FILTER,J.NEAREST);for(let K0=0;K0<c;K0++)if(S===J.TEXTURE_3D||S===J.TEXTURE_2D_ARRAY)J.texImage3D($0,0,J.RGBA,1,1,W0,0,J.RGBA,J.UNSIGNED_BYTE,E0);else J.texImage2D($0+K0,0,J.RGBA,1,1,0,J.RGBA,J.UNSIGNED_BYTE,E0);return a}let D0={};D0[J.TEXTURE_2D]=Z0(J.TEXTURE_2D,J.TEXTURE_2D,1),D0[J.TEXTURE_CUBE_MAP]=Z0(J.TEXTURE_CUBE_MAP,J.TEXTURE_CUBE_MAP_POSITIVE_X,6),D0[J.TEXTURE_2D_ARRAY]=Z0(J.TEXTURE_2D_ARRAY,J.TEXTURE_2D_ARRAY,1,1),D0[J.TEXTURE_3D]=Z0(J.TEXTURE_3D,J.TEXTURE_3D,1,1),K.setClear(0,0,0,1),H.setClear(1),Y.setClear(0),F0(J.DEPTH_TEST),H.setFunc(z7),bJ(!1),QJ(M7),F0(J.CULL_FACE),b0(eJ);function F0(S){if(N[S]!==!0)J.enable(S),N[S]=!0}function A0(S){if(N[S]!==!1)J.disable(S),N[S]=!1}function p0(S,$0){if(G[S]!==$0){if(J.bindFramebuffer(S,$0),G[S]=$0,S===J.DRAW_FRAMEBUFFER)G[J.FRAMEBUFFER]=$0;if(S===J.FRAMEBUFFER)G[J.DRAW_FRAMEBUFFER]=$0;return!0}return!1}function v0(S,$0){let c=L,W0=!1;if(S){if(c=O.get($0),c===void 0)c=[],O.set($0,c);let E0=S.textures;if(c.length!==E0.length||c[0]!==J.COLOR_ATTACHMENT0){for(let a=0,K0=E0.length;a<K0;a++)c[a]=J.COLOR_ATTACHMENT0+a;c.length=E0.length,W0=!0}}else if(c[0]!==J.BACK)c[0]=J.BACK,W0=!0;if(W0)J.drawBuffers(c)}function f0(S){if(z!==S)return J.useProgram(S),z=S,!0;return!1}let t0={[O8]:J.FUNC_ADD,[h$]:J.FUNC_SUBTRACT,[x$]:J.FUNC_REVERSE_SUBTRACT};t0[g$]=J.MIN,t0[p$]=J.MAX;let m0={[m$]:J.ZERO,[d$]:J.ONE,[l$]:J.SRC_COLOR,[c$]:J.SRC_ALPHA,[r$]:J.SRC_ALPHA_SATURATE,[o$]:J.DST_COLOR,[s$]:J.DST_ALPHA,[u$]:J.ONE_MINUS_SRC_COLOR,[n$]:J.ONE_MINUS_SRC_ALPHA,[a$]:J.ONE_MINUS_DST_COLOR,[i$]:J.ONE_MINUS_DST_ALPHA,[t$]:J.CONSTANT_COLOR,[e$]:J.ONE_MINUS_CONSTANT_COLOR,[JZ]:J.CONSTANT_ALPHA,[QZ]:J.ONE_MINUS_CONSTANT_ALPHA};function b0(S,$0,c,W0,E0,a,K0,T0,HJ,e0){if(S===eJ){if(D===!0)A0(J.BLEND),D=!1;return}if(D===!1)F0(J.BLEND),D=!0;if(S!==b$){if(S!==E||e0!==l){if(_!==O8||I!==O8)J.blendEquation(J.FUNC_ADD),_=O8,I=O8;if(e0)switch(S){case y8:J.blendFuncSeparate(J.ONE,J.ONE_MINUS_SRC_ALPHA,J.ONE,J.ONE_MINUS_SRC_ALPHA);break;case L7:J.blendFunc(J.ONE,J.ONE);break;case V7:J.blendFuncSeparate(J.ZERO,J.ONE_MINUS_SRC_COLOR,J.ZERO,J.ONE);break;case B7:J.blendFuncSeparate(J.DST_COLOR,J.ONE_MINUS_SRC_ALPHA,J.ZERO,J.ONE);break;default:P0("WebGLState: Invalid blending: ",S);break}else switch(S){case y8:J.blendFuncSeparate(J.SRC_ALPHA,J.ONE_MINUS_SRC_ALPHA,J.ONE,J.ONE_MINUS_SRC_ALPHA);break;case L7:J.blendFuncSeparate(J.SRC_ALPHA,J.ONE,J.ONE,J.ONE);break;case V7:P0("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case B7:P0("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:P0("WebGLState: Invalid blending: ",S);break}C=null,V=null,w=null,P=null,k.set(0,0,0),B=0,E=S,l=e0}return}if(E0=E0||$0,a=a||c,K0=K0||W0,$0!==_||E0!==I)J.blendEquationSeparate(t0[$0],t0[E0]),_=$0,I=E0;if(c!==C||W0!==V||a!==w||K0!==P)J.blendFuncSeparate(m0[c],m0[W0],m0[a],m0[K0]),C=c,V=W0,w=a,P=K0;if(T0.equals(k)===!1||HJ!==B)J.blendColor(T0.r,T0.g,T0.b,HJ),k.copy(T0),B=HJ;E=S,l=!1}function FJ(S,$0){S.side===tJ?A0(J.CULL_FACE):F0(J.CULL_FACE);let c=S.side===CJ;if($0)c=!c;bJ(c),S.blending===y8&&S.transparent===!1?b0(eJ):b0(S.blending,S.blendEquation,S.blendSrc,S.blendDst,S.blendEquationAlpha,S.blendSrcAlpha,S.blendDstAlpha,S.blendColor,S.blendAlpha,S.premultipliedAlpha),H.setFunc(S.depthFunc),H.setTest(S.depthTest),H.setMask(S.depthWrite),K.setMask(S.colorWrite);let W0=S.stencilWrite;if(Y.setTest(W0),W0)Y.setMask(S.stencilWriteMask),Y.setFunc(S.stencilFunc,S.stencilRef,S.stencilFuncMask),Y.setOp(S.stencilFail,S.stencilZFail,S.stencilZPass);OJ(S.polygonOffset,S.polygonOffsetFactor,S.polygonOffsetUnits),S.alphaToCoverage===!0?F0(J.SAMPLE_ALPHA_TO_COVERAGE):A0(J.SAMPLE_ALPHA_TO_COVERAGE)}function bJ(S){if(A!==S){if(S)J.frontFace(J.CW);else J.frontFace(J.CCW);A=S}}function QJ(S){if(S!==y$){if(F0(J.CULL_FACE),S!==m)if(S===M7)J.cullFace(J.BACK);else if(S===v$)J.cullFace(J.FRONT);else J.cullFace(J.FRONT_AND_BACK)}else A0(J.CULL_FACE);m=S}function RJ(S){if(S!==o){if(h)J.lineWidth(S);o=S}}function OJ(S,$0,c){if(S){if(F0(J.POLYGON_OFFSET_FILL),p!==$0||n!==c){if(p=$0,n=c,H.getReversed())$0=-$0;J.polygonOffset($0,c)}}else A0(J.POLYGON_OFFSET_FILL)}function qJ(S){if(S)F0(J.SCISSOR_TEST);else A0(J.SCISSOR_TEST)}function j(S){if(S===void 0)S=J.TEXTURE0+u-1;if(H0!==S)J.activeTexture(S),H0=S}function hJ(S,$0,c){if(c===void 0)if(H0===null)c=J.TEXTURE0+u-1;else c=H0;let W0=M0[c];if(W0===void 0)W0={type:void 0,texture:void 0},M0[c]=W0;if(W0.type!==S||W0.texture!==$0){if(H0!==c)J.activeTexture(c),H0=c;J.bindTexture(S,$0||D0[S]),W0.type=S,W0.texture=$0}}function c0(){let S=M0[H0];if(S!==void 0&&S.type!==void 0)J.bindTexture(S.type,null),S.type=void 0,S.texture=void 0}function $J(){try{J.compressedTexImage2D(...arguments)}catch(S){P0("WebGLState:",S)}}function M(){try{J.compressedTexImage3D(...arguments)}catch(S){P0("WebGLState:",S)}}function F(){try{J.texSubImage2D(...arguments)}catch(S){P0("WebGLState:",S)}}function T(){try{J.texSubImage3D(...arguments)}catch(S){P0("WebGLState:",S)}}function g(){try{J.compressedTexSubImage2D(...arguments)}catch(S){P0("WebGLState:",S)}}function r(){try{J.compressedTexSubImage3D(...arguments)}catch(S){P0("WebGLState:",S)}}function J0(){try{J.texStorage2D(...arguments)}catch(S){P0("WebGLState:",S)}}function Y0(){try{J.texStorage3D(...arguments)}catch(S){P0("WebGLState:",S)}}function d(){try{J.texImage2D(...arguments)}catch(S){P0("WebGLState:",S)}}function s(){try{J.texImage3D(...arguments)}catch(S){P0("WebGLState:",S)}}function q0(S){if(q[S]!==void 0)return q[S];else return J.getParameter(S)}function V0(S,$0){if(q[S]!==$0)J.pixelStorei(S,$0),q[S]=$0}function X0(S){if(i0.equals(S)===!1)J.scissor(S.x,S.y,S.z,S.w),i0.copy(S)}function Q0(S){if(i.equals(S)===!1)J.viewport(S.x,S.y,S.z,S.w),i.copy(S)}function w0(S,$0){let c=U.get($0);if(c===void 0)c=new WeakMap,U.set($0,c);let W0=c.get(S);if(W0===void 0)W0=J.getUniformBlockIndex($0,S.name),c.set(S,W0)}function I0(S,$0){let W0=U.get($0).get(S);if(X.get($0)!==W0)J.uniformBlockBinding($0,W0,S.__bindingPointIndex),X.set($0,W0)}function u0(){J.disable(J.BLEND),J.disable(J.CULL_FACE),J.disable(J.DEPTH_TEST),J.disable(J.POLYGON_OFFSET_FILL),J.disable(J.SCISSOR_TEST),J.disable(J.STENCIL_TEST),J.disable(J.SAMPLE_ALPHA_TO_COVERAGE),J.blendEquation(J.FUNC_ADD),J.blendFunc(J.ONE,J.ZERO),J.blendFuncSeparate(J.ONE,J.ZERO,J.ONE,J.ZERO),J.blendColor(0,0,0,0),J.colorMask(!0,!0,!0,!0),J.clearColor(0,0,0,0),J.depthMask(!0),J.depthFunc(J.LESS),H.setReversed(!1),J.clearDepth(1),J.stencilMask(4294967295),J.stencilFunc(J.ALWAYS,0,4294967295),J.stencilOp(J.KEEP,J.KEEP,J.KEEP),J.clearStencil(0),J.cullFace(J.BACK),J.frontFace(J.CCW),J.polygonOffset(0,0),J.activeTexture(J.TEXTURE0),J.bindFramebuffer(J.FRAMEBUFFER,null),J.bindFramebuffer(J.DRAW_FRAMEBUFFER,null),J.bindFramebuffer(J.READ_FRAMEBUFFER,null),J.useProgram(null),J.lineWidth(1),J.scissor(0,0,J.canvas.width,J.canvas.height),J.viewport(0,0,J.canvas.width,J.canvas.height),J.pixelStorei(J.PACK_ALIGNMENT,4),J.pixelStorei(J.UNPACK_ALIGNMENT,4),J.pixelStorei(J.UNPACK_FLIP_Y_WEBGL,!1),J.pixelStorei(J.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),J.pixelStorei(J.UNPACK_COLORSPACE_CONVERSION_WEBGL,J.BROWSER_DEFAULT_WEBGL),J.pixelStorei(J.PACK_ROW_LENGTH,0),J.pixelStorei(J.PACK_SKIP_PIXELS,0),J.pixelStorei(J.PACK_SKIP_ROWS,0),J.pixelStorei(J.UNPACK_ROW_LENGTH,0),J.pixelStorei(J.UNPACK_IMAGE_HEIGHT,0),J.pixelStorei(J.UNPACK_SKIP_PIXELS,0),J.pixelStorei(J.UNPACK_SKIP_ROWS,0),J.pixelStorei(J.UNPACK_SKIP_IMAGES,0),N={},q={},H0=null,M0={},G={},O=new WeakMap,L=[],z=null,D=!1,E=null,_=null,C=null,V=null,I=null,w=null,P=null,k=new l0(0,0,0),B=0,l=!1,A=null,m=null,o=null,p=null,n=null,i0.set(0,0,J.canvas.width,J.canvas.height),i.set(0,0,J.canvas.width,J.canvas.height),K.reset(),H.reset(),Y.reset()}return{buffers:{color:K,depth:H,stencil:Y},enable:F0,disable:A0,bindFramebuffer:p0,drawBuffers:v0,useProgram:f0,setBlending:b0,setMaterial:FJ,setFlipSided:bJ,setCullFace:QJ,setLineWidth:RJ,setPolygonOffset:OJ,setScissorTest:qJ,activeTexture:j,bindTexture:hJ,unbindTexture:c0,compressedTexImage2D:$J,compressedTexImage3D:M,texImage2D:d,texImage3D:s,pixelStorei:V0,getParameter:q0,updateUBOMapping:w0,uniformBlockBinding:I0,texStorage2D:J0,texStorage3D:Y0,texSubImage2D:F,texSubImage3D:T,compressedTexSubImage2D:g,compressedTexSubImage3D:r,scissor:X0,viewport:Q0,reset:u0}}function lU(J,Q,$,Z,W,K,H){let Y=Q.has("WEBGL_multisampled_render_to_texture")?Q.get("WEBGL_multisampled_render_to_texture"):null,X=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),U=new g0,N=new WeakMap,q=new Set,G,O=new WeakMap,L=!1;try{L=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch(M){}function z(M,F){return L?new OffscreenCanvas(M,F):S8("canvas")}function D(M,F,T){let g=1,r=$J(M);if(r.width>T||r.height>T)g=T/Math.max(r.width,r.height);if(g<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){let J0=Math.floor(g*r.width),Y0=Math.floor(g*r.height);if(G===void 0)G=z(J0,Y0);let d=F?z(J0,Y0):G;return d.width=J0,d.height=Y0,d.getContext("2d").drawImage(M,0,0,J0,Y0),C0("WebGLRenderer: Texture has been resized from ("+r.width+"x"+r.height+") to ("+J0+"x"+Y0+")."),d}else{if("data"in M)C0("WebGLRenderer: Image in DataTexture is too big ("+r.width+"x"+r.height+").");return M}return M}function E(M){return M.generateMipmaps}function _(M){J.generateMipmap(M)}function C(M){if(M.isWebGLCubeRenderTarget)return J.TEXTURE_CUBE_MAP;if(M.isWebGL3DRenderTarget)return J.TEXTURE_3D;if(M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture)return J.TEXTURE_2D_ARRAY;return J.TEXTURE_2D}function V(M,F,T,g,r,J0=!1){if(M!==null){if(J[M]!==void 0)return J[M];C0("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let Y0;if(g){if(Y0=Q.get("EXT_texture_norm16"),!Y0)C0("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension")}let d=F;if(F===J.RED){if(T===J.FLOAT)d=J.R32F;if(T===J.HALF_FLOAT)d=J.R16F;if(T===J.UNSIGNED_BYTE)d=J.R8;if(T===J.UNSIGNED_SHORT&&Y0)d=Y0.R16_EXT;if(T===J.SHORT&&Y0)d=Y0.R16_SNORM_EXT}if(F===J.RED_INTEGER){if(T===J.UNSIGNED_BYTE)d=J.R8UI;if(T===J.UNSIGNED_SHORT)d=J.R16UI;if(T===J.UNSIGNED_INT)d=J.R32UI;if(T===J.BYTE)d=J.R8I;if(T===J.SHORT)d=J.R16I;if(T===J.INT)d=J.R32I}if(F===J.RG){if(T===J.FLOAT)d=J.RG32F;if(T===J.HALF_FLOAT)d=J.RG16F;if(T===J.UNSIGNED_BYTE)d=J.RG8;if(T===J.UNSIGNED_SHORT&&Y0)d=Y0.RG16_EXT;if(T===J.SHORT&&Y0)d=Y0.RG16_SNORM_EXT}if(F===J.RG_INTEGER){if(T===J.UNSIGNED_BYTE)d=J.RG8UI;if(T===J.UNSIGNED_SHORT)d=J.RG16UI;if(T===J.UNSIGNED_INT)d=J.RG32UI;if(T===J.BYTE)d=J.RG8I;if(T===J.SHORT)d=J.RG16I;if(T===J.INT)d=J.RG32I}if(F===J.RGB_INTEGER){if(T===J.UNSIGNED_BYTE)d=J.RGB8UI;if(T===J.UNSIGNED_SHORT)d=J.RGB16UI;if(T===J.UNSIGNED_INT)d=J.RGB32UI;if(T===J.BYTE)d=J.RGB8I;if(T===J.SHORT)d=J.RGB16I;if(T===J.INT)d=J.RGB32I}if(F===J.RGBA_INTEGER){if(T===J.UNSIGNED_BYTE)d=J.RGBA8UI;if(T===J.UNSIGNED_SHORT)d=J.RGBA16UI;if(T===J.UNSIGNED_INT)d=J.RGBA32UI;if(T===J.BYTE)d=J.RGBA8I;if(T===J.SHORT)d=J.RGBA16I;if(T===J.INT)d=J.RGBA32I}if(F===J.RGB){if(T===J.UNSIGNED_SHORT&&Y0)d=Y0.RGB16_EXT;if(T===J.SHORT&&Y0)d=Y0.RGB16_SNORM_EXT;if(T===J.UNSIGNED_INT_5_9_9_9_REV)d=J.RGB9_E5;if(T===J.UNSIGNED_INT_10F_11F_11F_REV)d=J.R11F_G11F_B10F}if(F===J.RGBA){let s=J0?FQ:h0.getTransfer(r);if(T===J.FLOAT)d=J.RGBA32F;if(T===J.HALF_FLOAT)d=J.RGBA16F;if(T===J.UNSIGNED_BYTE)d=s===r0?J.SRGB8_ALPHA8:J.RGBA8;if(T===J.UNSIGNED_SHORT&&Y0)d=Y0.RGBA16_EXT;if(T===J.SHORT&&Y0)d=Y0.RGBA16_SNORM_EXT;if(T===J.UNSIGNED_SHORT_4_4_4_4)d=J.RGBA4;if(T===J.UNSIGNED_SHORT_5_5_5_1)d=J.RGB5_A1}if(d===J.R16F||d===J.R32F||d===J.RG16F||d===J.RG32F||d===J.RGBA16F||d===J.RGBA32F)Q.get("EXT_color_buffer_float");return d}function I(M,F){let T;if(M){if(F===null||F===P9||F===R8)T=J.DEPTH24_STENCIL8;else if(F===q9)T=J.DEPTH32F_STENCIL8;else if(F===b8)T=J.DEPTH24_STENCIL8,C0("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")}else if(F===null||F===P9||F===R8)T=J.DEPTH_COMPONENT24;else if(F===q9)T=J.DEPTH_COMPONENT32F;else if(F===b8)T=J.DEPTH_COMPONENT16;return T}function w(M,F){if(E(M)===!0||M.isFramebufferTexture&&M.minFilter!==C9&&M.minFilter!==PJ)return Math.log2(Math.max(F.width,F.height))+1;else if(M.mipmaps!==void 0&&M.mipmaps.length>0)return M.mipmaps.length;else if(M.isCompressedTexture&&Array.isArray(M.image))return F.mipmaps.length;else return 1}function P(M){let F=M.target;if(F.removeEventListener("dispose",P),B(F),F.isVideoTexture)N.delete(F);if(F.isHTMLTexture)q.delete(F)}function k(M){let F=M.target;F.removeEventListener("dispose",k),A(F)}function B(M){let F=Z.get(M);if(F.__webglInit===void 0)return;let T=M.source,g=O.get(T);if(g){let r=g[F.__cacheKey];if(r.usedTimes--,r.usedTimes===0)l(M);if(Object.keys(g).length===0)O.delete(T)}Z.remove(M)}function l(M){let F=Z.get(M);J.deleteTexture(F.__webglTexture);let T=M.source,g=O.get(T);delete g[F.__cacheKey],H.memory.textures--}function A(M){let F=Z.get(M);if(M.depthTexture)M.depthTexture.dispose(),Z.remove(M.depthTexture);if(M.isWebGLCubeRenderTarget)for(let g=0;g<6;g++){if(Array.isArray(F.__webglFramebuffer[g]))for(let r=0;r<F.__webglFramebuffer[g].length;r++)J.deleteFramebuffer(F.__webglFramebuffer[g][r]);else J.deleteFramebuffer(F.__webglFramebuffer[g]);if(F.__webglDepthbuffer)J.deleteRenderbuffer(F.__webglDepthbuffer[g])}else{if(Array.isArray(F.__webglFramebuffer))for(let g=0;g<F.__webglFramebuffer.length;g++)J.deleteFramebuffer(F.__webglFramebuffer[g]);else J.deleteFramebuffer(F.__webglFramebuffer);if(F.__webglDepthbuffer)J.deleteRenderbuffer(F.__webglDepthbuffer);if(F.__webglMultisampledFramebuffer)J.deleteFramebuffer(F.__webglMultisampledFramebuffer);if(F.__webglColorRenderbuffer){for(let g=0;g<F.__webglColorRenderbuffer.length;g++)if(F.__webglColorRenderbuffer[g])J.deleteRenderbuffer(F.__webglColorRenderbuffer[g])}if(F.__webglDepthRenderbuffer)J.deleteRenderbuffer(F.__webglDepthRenderbuffer)}let T=M.textures;for(let g=0,r=T.length;g<r;g++){let J0=Z.get(T[g]);if(J0.__webglTexture)J.deleteTexture(J0.__webglTexture),H.memory.textures--;Z.remove(T[g])}Z.remove(M)}let m=0;function o(){m=0}function p(){return m}function n(M){m=M}function u(){let M=m;if(M>=W.maxTextures)C0("WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+W.maxTextures);return m+=1,M}function h(M){let F=[];return F.push(M.wrapS),F.push(M.wrapT),F.push(M.wrapR||0),F.push(M.magFilter),F.push(M.minFilter),F.push(M.anisotropy),F.push(M.internalFormat),F.push(M.format),F.push(M.type),F.push(M.generateMipmaps),F.push(M.premultiplyAlpha),F.push(M.flipY),F.push(M.unpackAlignment),F.push(M.colorSpace),F.join()}function t(M,F){let T=Z.get(M);if(M.isVideoTexture)hJ(M);if(M.isRenderTargetTexture===!1&&M.isExternalTexture!==!0&&M.version>0&&T.__version!==M.version){let g=M.image;if(g===null)C0("WebGLRenderer: Texture marked for update but no image data found.");else if(g.complete===!1)C0("WebGLRenderer: Texture marked for update but image is incomplete");else{A0(T,M,F);return}}else if(M.isExternalTexture)T.__webglTexture=M.sourceTexture?M.sourceTexture:null;$.bindTexture(J.TEXTURE_2D,T.__webglTexture,J.TEXTURE0+F)}function e(M,F){let T=Z.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&T.__version!==M.version){A0(T,M,F);return}else if(M.isExternalTexture)T.__webglTexture=M.sourceTexture?M.sourceTexture:null;$.bindTexture(J.TEXTURE_2D_ARRAY,T.__webglTexture,J.TEXTURE0+F)}function H0(M,F){let T=Z.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&T.__version!==M.version){A0(T,M,F);return}$.bindTexture(J.TEXTURE_3D,T.__webglTexture,J.TEXTURE0+F)}function M0(M,F){let T=Z.get(M);if(M.isCubeDepthTexture!==!0&&M.version>0&&T.__version!==M.version){p0(T,M,F);return}$.bindTexture(J.TEXTURE_CUBE_MAP,T.__webglTexture,J.TEXTURE0+F)}let R0={[qZ]:J.REPEAT,[R6]:J.CLAMP_TO_EDGE,[EZ]:J.MIRRORED_REPEAT},ZJ={[C9]:J.NEAREST,[DZ]:J.NEAREST_MIPMAP_NEAREST,[f8]:J.NEAREST_MIPMAP_LINEAR,[PJ]:J.LINEAR,[M6]:J.LINEAR_MIPMAP_NEAREST,[x9]:J.LINEAR_MIPMAP_LINEAR},i0={[wZ]:J.NEVER,[_Z]:J.ALWAYS,[IZ]:J.LESS,[A6]:J.LEQUAL,[AZ]:J.EQUAL,[C6]:J.GEQUAL,[CZ]:J.GREATER,[PZ]:J.NOTEQUAL};function i(M,F){if(F.type===q9&&Q.has("OES_texture_float_linear")===!1&&(F.magFilter===PJ||F.magFilter===M6||F.magFilter===f8||F.magFilter===x9||F.minFilter===PJ||F.minFilter===M6||F.minFilter===f8||F.minFilter===x9))C0("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device.");if(J.texParameteri(M,J.TEXTURE_WRAP_S,R0[F.wrapS]),J.texParameteri(M,J.TEXTURE_WRAP_T,R0[F.wrapT]),M===J.TEXTURE_3D||M===J.TEXTURE_2D_ARRAY)J.texParameteri(M,J.TEXTURE_WRAP_R,R0[F.wrapR]);if(J.texParameteri(M,J.TEXTURE_MAG_FILTER,ZJ[F.magFilter]),J.texParameteri(M,J.TEXTURE_MIN_FILTER,ZJ[F.minFilter]),F.compareFunction)J.texParameteri(M,J.TEXTURE_COMPARE_MODE,J.COMPARE_REF_TO_TEXTURE),J.texParameteri(M,J.TEXTURE_COMPARE_FUNC,i0[F.compareFunction]);if(Q.has("EXT_texture_filter_anisotropic")===!0){if(F.magFilter===C9)return;if(F.minFilter!==f8&&F.minFilter!==x9)return;if(F.type===q9&&Q.has("OES_texture_float_linear")===!1)return;if(F.anisotropy>1||Z.get(F).__currentAnisotropy){let T=Q.get("EXT_texture_filter_anisotropic");J.texParameterf(M,T.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(F.anisotropy,W.getMaxAnisotropy())),Z.get(F).__currentAnisotropy=F.anisotropy}}}function Z0(M,F){let T=!1;if(M.__webglInit===void 0)M.__webglInit=!0,F.addEventListener("dispose",P);let g=F.source,r=O.get(g);if(r===void 0)r={},O.set(g,r);let J0=h(F);if(J0!==M.__cacheKey){if(r[J0]===void 0)r[J0]={texture:J.createTexture(),usedTimes:0},H.memory.textures++,T=!0;r[J0].usedTimes++;let Y0=r[M.__cacheKey];if(Y0!==void 0){if(r[M.__cacheKey].usedTimes--,Y0.usedTimes===0)l(F)}M.__cacheKey=J0,M.__webglTexture=r[J0].texture}return T}function D0(M,F,T){return Math.floor(Math.floor(M/T)/F)}function F0(M,F,T,g){let J0=M.updateRanges;if(J0.length===0)$.texSubImage2D(J.TEXTURE_2D,0,0,0,F.width,F.height,T,g,F.data);else{J0.sort((V0,X0)=>V0.start-X0.start);let Y0=0;for(let V0=1;V0<J0.length;V0++){let X0=J0[Y0],Q0=J0[V0],w0=X0.start+X0.count,I0=D0(Q0.start,F.width,4),u0=D0(X0.start,F.width,4);if(Q0.start<=w0+1&&I0===u0&&D0(Q0.start+Q0.count-1,F.width,4)===I0)X0.count=Math.max(X0.count,Q0.start+Q0.count-X0.start);else++Y0,J0[Y0]=Q0}J0.length=Y0+1;let d=$.getParameter(J.UNPACK_ROW_LENGTH),s=$.getParameter(J.UNPACK_SKIP_PIXELS),q0=$.getParameter(J.UNPACK_SKIP_ROWS);$.pixelStorei(J.UNPACK_ROW_LENGTH,F.width);for(let V0=0,X0=J0.length;V0<X0;V0++){let Q0=J0[V0],w0=Math.floor(Q0.start/4),I0=Math.ceil(Q0.count/4),u0=w0%F.width,S=Math.floor(w0/F.width),$0=I0,c=1;$.pixelStorei(J.UNPACK_SKIP_PIXELS,u0),$.pixelStorei(J.UNPACK_SKIP_ROWS,S),$.texSubImage2D(J.TEXTURE_2D,0,u0,S,$0,1,T,g,F.data)}M.clearUpdateRanges(),$.pixelStorei(J.UNPACK_ROW_LENGTH,d),$.pixelStorei(J.UNPACK_SKIP_PIXELS,s),$.pixelStorei(J.UNPACK_SKIP_ROWS,q0)}}function A0(M,F,T){let g=J.TEXTURE_2D;if(F.isDataArrayTexture||F.isCompressedArrayTexture)g=J.TEXTURE_2D_ARRAY;if(F.isData3DTexture)g=J.TEXTURE_3D;let r=Z0(M,F),J0=F.source;$.bindTexture(g,M.__webglTexture,J.TEXTURE0+T);let Y0=Z.get(J0);if(J0.version!==Y0.__version||r===!0){if($.activeTexture(J.TEXTURE0+T),(typeof ImageBitmap<"u"&&F.image instanceof ImageBitmap)===!1){let c=h0.getPrimaries(h0.workingColorSpace),W0=F.colorSpace===d9?null:h0.getPrimaries(F.colorSpace),E0=F.colorSpace===d9||c===W0?J.NONE:J.BROWSER_DEFAULT_WEBGL;$.pixelStorei(J.UNPACK_FLIP_Y_WEBGL,F.flipY),$.pixelStorei(J.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),$.pixelStorei(J.UNPACK_COLORSPACE_CONVERSION_WEBGL,E0)}$.pixelStorei(J.UNPACK_ALIGNMENT,F.unpackAlignment);let s=D(F.image,!1,W.maxTextureSize);s=c0(F,s);let q0=K.convert(F.format,F.colorSpace),V0=K.convert(F.type),X0=V(F.internalFormat,q0,V0,F.normalized,F.colorSpace,F.isVideoTexture);i(g,F);let Q0,w0=F.mipmaps,I0=F.isVideoTexture!==!0,u0=Y0.__version===void 0||r===!0,S=J0.dataReady,$0=w(F,s);if(F.isDepthTexture){if(X0=I(F.format===p9,F.type),u0)if(I0)$.texStorage2D(J.TEXTURE_2D,1,X0,s.width,s.height);else $.texImage2D(J.TEXTURE_2D,0,X0,s.width,s.height,0,q0,V0,null)}else if(F.isDataTexture)if(w0.length>0){if(I0&&u0)$.texStorage2D(J.TEXTURE_2D,$0,X0,w0[0].width,w0[0].height);for(let c=0,W0=w0.length;c<W0;c++)if(Q0=w0[c],I0){if(S)$.texSubImage2D(J.TEXTURE_2D,c,0,0,Q0.width,Q0.height,q0,V0,Q0.data)}else $.texImage2D(J.TEXTURE_2D,c,X0,Q0.width,Q0.height,0,q0,V0,Q0.data);F.generateMipmaps=!1}else if(I0){if(u0)$.texStorage2D(J.TEXTURE_2D,$0,X0,s.width,s.height);if(S)F0(F,s,q0,V0)}else $.texImage2D(J.TEXTURE_2D,0,X0,s.width,s.height,0,q0,V0,s.data);else if(F.isCompressedTexture)if(F.isCompressedArrayTexture){if(I0&&u0)$.texStorage3D(J.TEXTURE_2D_ARRAY,$0,X0,w0[0].width,w0[0].height,s.depth);for(let c=0,W0=w0.length;c<W0;c++)if(Q0=w0[c],F.format!==J9)if(q0!==null)if(I0){if(S)if(F.layerUpdates.size>0){let E0=uQ(Q0.width,Q0.height,F.format,F.type);for(let a of F.layerUpdates){let K0=Q0.data.subarray(a*E0/Q0.data.BYTES_PER_ELEMENT,(a+1)*E0/Q0.data.BYTES_PER_ELEMENT);$.compressedTexSubImage3D(J.TEXTURE_2D_ARRAY,c,0,0,a,Q0.width,Q0.height,1,q0,K0)}F.clearLayerUpdates()}else $.compressedTexSubImage3D(J.TEXTURE_2D_ARRAY,c,0,0,0,Q0.width,Q0.height,s.depth,q0,Q0.data)}else $.compressedTexImage3D(J.TEXTURE_2D_ARRAY,c,X0,Q0.width,Q0.height,s.depth,0,Q0.data,0,0);else C0("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else if(I0){if(S)$.texSubImage3D(J.TEXTURE_2D_ARRAY,c,0,0,0,Q0.width,Q0.height,s.depth,q0,V0,Q0.data)}else $.texImage3D(J.TEXTURE_2D_ARRAY,c,X0,Q0.width,Q0.height,s.depth,0,q0,V0,Q0.data)}else{if(I0&&u0)$.texStorage2D(J.TEXTURE_2D,$0,X0,w0[0].width,w0[0].height);for(let c=0,W0=w0.length;c<W0;c++)if(Q0=w0[c],F.format!==J9)if(q0!==null)if(I0){if(S)$.compressedTexSubImage2D(J.TEXTURE_2D,c,0,0,Q0.width,Q0.height,q0,Q0.data)}else $.compressedTexImage2D(J.TEXTURE_2D,c,X0,Q0.width,Q0.height,0,Q0.data);else C0("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else if(I0){if(S)$.texSubImage2D(J.TEXTURE_2D,c,0,0,Q0.width,Q0.height,q0,V0,Q0.data)}else $.texImage2D(J.TEXTURE_2D,c,X0,Q0.width,Q0.height,0,q0,V0,Q0.data)}else if(F.isDataArrayTexture)if(I0){if(u0)$.texStorage3D(J.TEXTURE_2D_ARRAY,$0,X0,s.width,s.height,s.depth);if(S)if(F.layerUpdates.size>0){let c=uQ(s.width,s.height,F.format,F.type);for(let W0 of F.layerUpdates){let E0=s.data.subarray(W0*c/s.data.BYTES_PER_ELEMENT,(W0+1)*c/s.data.BYTES_PER_ELEMENT);$.texSubImage3D(J.TEXTURE_2D_ARRAY,0,0,0,W0,s.width,s.height,1,q0,V0,E0)}F.clearLayerUpdates()}else $.texSubImage3D(J.TEXTURE_2D_ARRAY,0,0,0,0,s.width,s.height,s.depth,q0,V0,s.data)}else $.texImage3D(J.TEXTURE_2D_ARRAY,0,X0,s.width,s.height,s.depth,0,q0,V0,s.data);else if(F.isData3DTexture)if(I0){if(u0)$.texStorage3D(J.TEXTURE_3D,$0,X0,s.width,s.height,s.depth);if(S)$.texSubImage3D(J.TEXTURE_3D,0,0,0,0,s.width,s.height,s.depth,q0,V0,s.data)}else $.texImage3D(J.TEXTURE_3D,0,X0,s.width,s.height,s.depth,0,q0,V0,s.data);else if(F.isFramebufferTexture){if(u0)if(I0)$.texStorage2D(J.TEXTURE_2D,$0,X0,s.width,s.height);else{let{width:c,height:W0}=s;for(let E0=0;E0<$0;E0++)$.texImage2D(J.TEXTURE_2D,E0,X0,c,W0,0,q0,V0,null),c>>=1,W0>>=1}}else if(F.isHTMLTexture){if("texElementImage2D"in J){let c=J.canvas;if(!c.hasAttribute("layoutsubtree"))c.setAttribute("layoutsubtree","true");if(s.parentNode!==c){c.appendChild(s),q.add(F),c.onpaint=(W0)=>{let E0=W0.changedElements;for(let a of q)if(E0.includes(a.image))a.needsUpdate=!0},c.requestPaint();return}if(J.texElementImage2D.length===3)J.texElementImage2D(J.TEXTURE_2D,J.RGBA8,s);else{let{RGBA:E0,RGBA:a,UNSIGNED_BYTE:K0}=J;J.texElementImage2D(J.TEXTURE_2D,0,E0,a,K0,s)}J.texParameteri(J.TEXTURE_2D,J.TEXTURE_MIN_FILTER,J.LINEAR),J.texParameteri(J.TEXTURE_2D,J.TEXTURE_WRAP_S,J.CLAMP_TO_EDGE),J.texParameteri(J.TEXTURE_2D,J.TEXTURE_WRAP_T,J.CLAMP_TO_EDGE)}}else if(w0.length>0){if(I0&&u0){let c=$J(w0[0]);$.texStorage2D(J.TEXTURE_2D,$0,X0,c.width,c.height)}for(let c=0,W0=w0.length;c<W0;c++)if(Q0=w0[c],I0){if(S)$.texSubImage2D(J.TEXTURE_2D,c,0,0,q0,V0,Q0)}else $.texImage2D(J.TEXTURE_2D,c,X0,q0,V0,Q0);F.generateMipmaps=!1}else if(I0){if(u0){let c=$J(s);$.texStorage2D(J.TEXTURE_2D,$0,X0,c.width,c.height)}if(S)$.texSubImage2D(J.TEXTURE_2D,0,0,0,q0,V0,s)}else $.texImage2D(J.TEXTURE_2D,0,X0,q0,V0,s);if(E(F))_(g);if(Y0.__version=J0.version,F.onUpdate)F.onUpdate(F)}M.__version=F.version}function p0(M,F,T){if(F.image.length!==6)return;let g=Z0(M,F),r=F.source;$.bindTexture(J.TEXTURE_CUBE_MAP,M.__webglTexture,J.TEXTURE0+T);let J0=Z.get(r);if(r.version!==J0.__version||g===!0){$.activeTexture(J.TEXTURE0+T);let Y0=h0.getPrimaries(h0.workingColorSpace),d=F.colorSpace===d9?null:h0.getPrimaries(F.colorSpace),s=F.colorSpace===d9||Y0===d?J.NONE:J.BROWSER_DEFAULT_WEBGL;$.pixelStorei(J.UNPACK_FLIP_Y_WEBGL,F.flipY),$.pixelStorei(J.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),$.pixelStorei(J.UNPACK_ALIGNMENT,F.unpackAlignment),$.pixelStorei(J.UNPACK_COLORSPACE_CONVERSION_WEBGL,s);let q0=F.isCompressedTexture||F.image[0].isCompressedTexture,V0=F.image[0]&&F.image[0].isDataTexture,X0=[];for(let a=0;a<6;a++){if(!q0&&!V0)X0[a]=D(F.image[a],!0,W.maxCubemapSize);else X0[a]=V0?F.image[a].image:F.image[a];X0[a]=c0(F,X0[a])}let Q0=X0[0],w0=K.convert(F.format,F.colorSpace),I0=K.convert(F.type),u0=V(F.internalFormat,w0,I0,F.normalized,F.colorSpace),S=F.isVideoTexture!==!0,$0=J0.__version===void 0||g===!0,c=r.dataReady,W0=w(F,Q0);i(J.TEXTURE_CUBE_MAP,F);let E0;if(q0){if(S&&$0)$.texStorage2D(J.TEXTURE_CUBE_MAP,W0,u0,Q0.width,Q0.height);for(let a=0;a<6;a++){E0=X0[a].mipmaps;for(let K0=0;K0<E0.length;K0++){let T0=E0[K0];if(F.format!==J9)if(w0!==null)if(S){if(c)$.compressedTexSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,K0,0,0,T0.width,T0.height,w0,T0.data)}else $.compressedTexImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,K0,u0,T0.width,T0.height,0,T0.data);else C0("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()");else if(S){if(c)$.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,K0,0,0,T0.width,T0.height,w0,I0,T0.data)}else $.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,K0,u0,T0.width,T0.height,0,w0,I0,T0.data)}}}else{if(E0=F.mipmaps,S&&$0){if(E0.length>0)W0++;let a=$J(X0[0]);$.texStorage2D(J.TEXTURE_CUBE_MAP,W0,u0,a.width,a.height)}for(let a=0;a<6;a++)if(V0){if(S){if(c)$.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,0,0,0,X0[a].width,X0[a].height,w0,I0,X0[a].data)}else $.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,0,u0,X0[a].width,X0[a].height,0,w0,I0,X0[a].data);for(let K0=0;K0<E0.length;K0++){let HJ=E0[K0].image[a].image;if(S){if(c)$.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,K0+1,0,0,HJ.width,HJ.height,w0,I0,HJ.data)}else $.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,K0+1,u0,HJ.width,HJ.height,0,w0,I0,HJ.data)}}else{if(S){if(c)$.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,0,0,0,w0,I0,X0[a])}else $.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,0,u0,w0,I0,X0[a]);for(let K0=0;K0<E0.length;K0++){let T0=E0[K0];if(S){if(c)$.texSubImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,K0+1,0,0,w0,I0,T0.image[a])}else $.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+a,K0+1,u0,w0,I0,T0.image[a])}}}if(E(F))_(J.TEXTURE_CUBE_MAP);if(J0.__version=r.version,F.onUpdate)F.onUpdate(F)}M.__version=F.version}function v0(M,F,T,g,r,J0){let Y0=K.convert(T.format,T.colorSpace),d=K.convert(T.type),s=V(T.internalFormat,Y0,d,T.normalized,T.colorSpace),q0=Z.get(F),V0=Z.get(T);if(V0.__renderTarget=F,!q0.__hasExternalTextures){let X0=Math.max(1,F.width>>J0),Q0=Math.max(1,F.height>>J0);if(r===J.TEXTURE_3D||r===J.TEXTURE_2D_ARRAY)$.texImage3D(r,J0,s,X0,Q0,F.depth,0,Y0,d,null);else $.texImage2D(r,J0,s,X0,Q0,0,Y0,d,null)}if($.bindFramebuffer(J.FRAMEBUFFER,M),j(F))Y.framebufferTexture2DMultisampleEXT(J.FRAMEBUFFER,g,r,V0.__webglTexture,0,qJ(F));else if(r===J.TEXTURE_2D||r>=J.TEXTURE_CUBE_MAP_POSITIVE_X&&r<=J.TEXTURE_CUBE_MAP_NEGATIVE_Z)J.framebufferTexture2D(J.FRAMEBUFFER,g,r,V0.__webglTexture,J0);$.bindFramebuffer(J.FRAMEBUFFER,null)}function f0(M,F,T){if(J.bindRenderbuffer(J.RENDERBUFFER,M),F.depthBuffer){let g=F.depthTexture,r=g&&g.isDepthTexture?g.type:null,J0=I(F.stencilBuffer,r),Y0=F.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT;if(j(F))Y.renderbufferStorageMultisampleEXT(J.RENDERBUFFER,qJ(F),J0,F.width,F.height);else if(T)J.renderbufferStorageMultisample(J.RENDERBUFFER,qJ(F),J0,F.width,F.height);else J.renderbufferStorage(J.RENDERBUFFER,J0,F.width,F.height);J.framebufferRenderbuffer(J.FRAMEBUFFER,Y0,J.RENDERBUFFER,M)}else{let g=F.textures;for(let r=0;r<g.length;r++){let J0=g[r],Y0=K.convert(J0.format,J0.colorSpace),d=K.convert(J0.type),s=V(J0.internalFormat,Y0,d,J0.normalized,J0.colorSpace);if(j(F))Y.renderbufferStorageMultisampleEXT(J.RENDERBUFFER,qJ(F),s,F.width,F.height);else if(T)J.renderbufferStorageMultisample(J.RENDERBUFFER,qJ(F),s,F.width,F.height);else J.renderbufferStorage(J.RENDERBUFFER,s,F.width,F.height)}}J.bindRenderbuffer(J.RENDERBUFFER,null)}function t0(M,F,T){let g=F.isWebGLCubeRenderTarget===!0;if($.bindFramebuffer(J.FRAMEBUFFER,M),!(F.depthTexture&&F.depthTexture.isDepthTexture))throw Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let r=Z.get(F.depthTexture);if(r.__renderTarget=F,!r.__webglTexture||F.depthTexture.image.width!==F.width||F.depthTexture.image.height!==F.height)F.depthTexture.image.width=F.width,F.depthTexture.image.height=F.height,F.depthTexture.needsUpdate=!0;if(g){if(r.__webglInit===void 0)r.__webglInit=!0,F.depthTexture.addEventListener("dispose",P);if(r.__webglTexture===void 0){r.__webglTexture=J.createTexture(),$.bindTexture(J.TEXTURE_CUBE_MAP,r.__webglTexture),i(J.TEXTURE_CUBE_MAP,F.depthTexture);let q0=K.convert(F.depthTexture.format),V0=K.convert(F.depthTexture.type),X0;if(F.depthTexture.format===g9)X0=J.DEPTH_COMPONENT24;else if(F.depthTexture.format===p9)X0=J.DEPTH24_STENCIL8;for(let Q0=0;Q0<6;Q0++)J.texImage2D(J.TEXTURE_CUBE_MAP_POSITIVE_X+Q0,0,X0,F.width,F.height,0,q0,V0,null)}}else t(F.depthTexture,0);let J0=r.__webglTexture,Y0=qJ(F),d=g?J.TEXTURE_CUBE_MAP_POSITIVE_X+T:J.TEXTURE_2D,s=F.depthTexture.format===p9?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT;if(F.depthTexture.format===g9)if(j(F))Y.framebufferTexture2DMultisampleEXT(J.FRAMEBUFFER,s,d,J0,0,Y0);else J.framebufferTexture2D(J.FRAMEBUFFER,s,d,J0,0);else if(F.depthTexture.format===p9)if(j(F))Y.framebufferTexture2DMultisampleEXT(J.FRAMEBUFFER,s,d,J0,0,Y0);else J.framebufferTexture2D(J.FRAMEBUFFER,s,d,J0,0);else throw Error("THREE.WebGLTextures: Unknown depthTexture format.")}function m0(M){let F=Z.get(M),T=M.isWebGLCubeRenderTarget===!0;if(F.__boundDepthTexture!==M.depthTexture){let g=M.depthTexture;if(F.__depthDisposeCallback)F.__depthDisposeCallback();if(g){let r=()=>{delete F.__boundDepthTexture,delete F.__depthDisposeCallback,g.removeEventListener("dispose",r)};g.addEventListener("dispose",r),F.__depthDisposeCallback=r}F.__boundDepthTexture=g}if(M.depthTexture&&!F.__autoAllocateDepthBuffer)if(T)for(let g=0;g<6;g++)t0(F.__webglFramebuffer[g],M,g);else{let g=M.texture.mipmaps;if(g&&g.length>0)t0(F.__webglFramebuffer[0],M,0);else t0(F.__webglFramebuffer,M,0)}else if(T){F.__webglDepthbuffer=[];for(let g=0;g<6;g++)if($.bindFramebuffer(J.FRAMEBUFFER,F.__webglFramebuffer[g]),F.__webglDepthbuffer[g]===void 0)F.__webglDepthbuffer[g]=J.createRenderbuffer(),f0(F.__webglDepthbuffer[g],M,!1);else{let r=M.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT,J0=F.__webglDepthbuffer[g];J.bindRenderbuffer(J.RENDERBUFFER,J0),J.framebufferRenderbuffer(J.FRAMEBUFFER,r,J.RENDERBUFFER,J0)}}else{let g=M.texture.mipmaps;if(g&&g.length>0)$.bindFramebuffer(J.FRAMEBUFFER,F.__webglFramebuffer[0]);else $.bindFramebuffer(J.FRAMEBUFFER,F.__webglFramebuffer);if(F.__webglDepthbuffer===void 0)F.__webglDepthbuffer=J.createRenderbuffer(),f0(F.__webglDepthbuffer,M,!1);else{let r=M.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT,J0=F.__webglDepthbuffer;J.bindRenderbuffer(J.RENDERBUFFER,J0),J.framebufferRenderbuffer(J.FRAMEBUFFER,r,J.RENDERBUFFER,J0)}}$.bindFramebuffer(J.FRAMEBUFFER,null)}function b0(M,F,T){let g=Z.get(M);if(F!==void 0)v0(g.__webglFramebuffer,M,M.texture,J.COLOR_ATTACHMENT0,J.TEXTURE_2D,0);if(T!==void 0)m0(M)}function FJ(M){let F=M.texture,T=Z.get(M),g=Z.get(F);M.addEventListener("dispose",k);let r=M.textures,J0=M.isWebGLCubeRenderTarget===!0,Y0=r.length>1;if(!Y0){if(g.__webglTexture===void 0)g.__webglTexture=J.createTexture();g.__version=F.version,H.memory.textures++}if(J0){T.__webglFramebuffer=[];for(let d=0;d<6;d++)if(F.mipmaps&&F.mipmaps.length>0){T.__webglFramebuffer[d]=[];for(let s=0;s<F.mipmaps.length;s++)T.__webglFramebuffer[d][s]=J.createFramebuffer()}else T.__webglFramebuffer[d]=J.createFramebuffer()}else{if(F.mipmaps&&F.mipmaps.length>0){T.__webglFramebuffer=[];for(let d=0;d<F.mipmaps.length;d++)T.__webglFramebuffer[d]=J.createFramebuffer()}else T.__webglFramebuffer=J.createFramebuffer();if(Y0)for(let d=0,s=r.length;d<s;d++){let q0=Z.get(r[d]);if(q0.__webglTexture===void 0)q0.__webglTexture=J.createTexture(),H.memory.textures++}if(M.samples>0&&j(M)===!1){T.__webglMultisampledFramebuffer=J.createFramebuffer(),T.__webglColorRenderbuffer=[],$.bindFramebuffer(J.FRAMEBUFFER,T.__webglMultisampledFramebuffer);for(let d=0;d<r.length;d++){let s=r[d];T.__webglColorRenderbuffer[d]=J.createRenderbuffer(),J.bindRenderbuffer(J.RENDERBUFFER,T.__webglColorRenderbuffer[d]);let q0=K.convert(s.format,s.colorSpace),V0=K.convert(s.type),X0=V(s.internalFormat,q0,V0,s.normalized,s.colorSpace,M.isXRRenderTarget===!0),Q0=qJ(M);J.renderbufferStorageMultisample(J.RENDERBUFFER,Q0,X0,M.width,M.height),J.framebufferRenderbuffer(J.FRAMEBUFFER,J.COLOR_ATTACHMENT0+d,J.RENDERBUFFER,T.__webglColorRenderbuffer[d])}if(J.bindRenderbuffer(J.RENDERBUFFER,null),M.depthBuffer)T.__webglDepthRenderbuffer=J.createRenderbuffer(),f0(T.__webglDepthRenderbuffer,M,!0);$.bindFramebuffer(J.FRAMEBUFFER,null)}}if(J0){$.bindTexture(J.TEXTURE_CUBE_MAP,g.__webglTexture),i(J.TEXTURE_CUBE_MAP,F);for(let d=0;d<6;d++)if(F.mipmaps&&F.mipmaps.length>0)for(let s=0;s<F.mipmaps.length;s++)v0(T.__webglFramebuffer[d][s],M,F,J.COLOR_ATTACHMENT0,J.TEXTURE_CUBE_MAP_POSITIVE_X+d,s);else v0(T.__webglFramebuffer[d],M,F,J.COLOR_ATTACHMENT0,J.TEXTURE_CUBE_MAP_POSITIVE_X+d,0);if(E(F))_(J.TEXTURE_CUBE_MAP);$.unbindTexture()}else if(Y0){for(let d=0,s=r.length;d<s;d++){let q0=r[d],V0=Z.get(q0),X0=J.TEXTURE_2D;if(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)X0=M.isWebGL3DRenderTarget?J.TEXTURE_3D:J.TEXTURE_2D_ARRAY;if($.bindTexture(X0,V0.__webglTexture),i(X0,q0),v0(T.__webglFramebuffer,M,q0,J.COLOR_ATTACHMENT0+d,X0,0),E(q0))_(X0)}$.unbindTexture()}else{let d=J.TEXTURE_2D;if(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)d=M.isWebGL3DRenderTarget?J.TEXTURE_3D:J.TEXTURE_2D_ARRAY;if($.bindTexture(d,g.__webglTexture),i(d,F),F.mipmaps&&F.mipmaps.length>0)for(let s=0;s<F.mipmaps.length;s++)v0(T.__webglFramebuffer[s],M,F,J.COLOR_ATTACHMENT0,d,s);else v0(T.__webglFramebuffer,M,F,J.COLOR_ATTACHMENT0,d,0);if(E(F))_(d);$.unbindTexture()}if(M.depthBuffer)m0(M)}function bJ(M){let F=M.textures;for(let T=0,g=F.length;T<g;T++){let r=F[T];if(E(r)){let J0=C(M),Y0=Z.get(r).__webglTexture;$.bindTexture(J0,Y0),_(J0),$.unbindTexture()}}}let QJ=[],RJ=[];function OJ(M){if(M.samples>0){if(j(M)===!1){let{textures:F,width:T,height:g}=M,r=J.COLOR_BUFFER_BIT,J0=M.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT,Y0=Z.get(M),d=F.length>1;if(d)for(let q0=0;q0<F.length;q0++)$.bindFramebuffer(J.FRAMEBUFFER,Y0.__webglMultisampledFramebuffer),J.framebufferRenderbuffer(J.FRAMEBUFFER,J.COLOR_ATTACHMENT0+q0,J.RENDERBUFFER,null),$.bindFramebuffer(J.FRAMEBUFFER,Y0.__webglFramebuffer),J.framebufferTexture2D(J.DRAW_FRAMEBUFFER,J.COLOR_ATTACHMENT0+q0,J.TEXTURE_2D,null,0);$.bindFramebuffer(J.READ_FRAMEBUFFER,Y0.__webglMultisampledFramebuffer);let s=M.texture.mipmaps;if(s&&s.length>0)$.bindFramebuffer(J.DRAW_FRAMEBUFFER,Y0.__webglFramebuffer[0]);else $.bindFramebuffer(J.DRAW_FRAMEBUFFER,Y0.__webglFramebuffer);for(let q0=0;q0<F.length;q0++){if(M.resolveDepthBuffer){if(M.depthBuffer)r|=J.DEPTH_BUFFER_BIT;if(M.stencilBuffer&&M.resolveStencilBuffer)r|=J.STENCIL_BUFFER_BIT}if(d){J.framebufferRenderbuffer(J.READ_FRAMEBUFFER,J.COLOR_ATTACHMENT0,J.RENDERBUFFER,Y0.__webglColorRenderbuffer[q0]);let V0=Z.get(F[q0]).__webglTexture;J.framebufferTexture2D(J.DRAW_FRAMEBUFFER,J.COLOR_ATTACHMENT0,J.TEXTURE_2D,V0,0)}if(J.blitFramebuffer(0,0,T,g,0,0,T,g,r,J.NEAREST),X===!0){if(QJ.length=0,RJ.length=0,QJ.push(J.COLOR_ATTACHMENT0+q0),M.depthBuffer&&M.resolveDepthBuffer===!1)QJ.push(J0),RJ.push(J0),J.invalidateFramebuffer(J.DRAW_FRAMEBUFFER,RJ);J.invalidateFramebuffer(J.READ_FRAMEBUFFER,QJ)}}if($.bindFramebuffer(J.READ_FRAMEBUFFER,null),$.bindFramebuffer(J.DRAW_FRAMEBUFFER,null),d)for(let q0=0;q0<F.length;q0++){$.bindFramebuffer(J.FRAMEBUFFER,Y0.__webglMultisampledFramebuffer),J.framebufferRenderbuffer(J.FRAMEBUFFER,J.COLOR_ATTACHMENT0+q0,J.RENDERBUFFER,Y0.__webglColorRenderbuffer[q0]);let V0=Z.get(F[q0]).__webglTexture;$.bindFramebuffer(J.FRAMEBUFFER,Y0.__webglFramebuffer),J.framebufferTexture2D(J.DRAW_FRAMEBUFFER,J.COLOR_ATTACHMENT0+q0,J.TEXTURE_2D,V0,0)}$.bindFramebuffer(J.DRAW_FRAMEBUFFER,Y0.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&X){let F=M.stencilBuffer?J.DEPTH_STENCIL_ATTACHMENT:J.DEPTH_ATTACHMENT;J.invalidateFramebuffer(J.DRAW_FRAMEBUFFER,[F])}}}function qJ(M){return Math.min(W.maxSamples,M.samples)}function j(M){let F=Z.get(M);return M.samples>0&&Q.has("WEBGL_multisampled_render_to_texture")===!0&&F.__useRenderToTexture!==!1}function hJ(M){let F=H.render.frame;if(N.get(M)!==F)N.set(M,F),M.update()}function c0(M,F){let{colorSpace:T,format:g,type:r}=M;if(M.isCompressedTexture===!0||M.isVideoTexture===!0)return F;if(T!==DQ&&T!==d9)if(h0.getTransfer(T)===r0){if(g!==J9||r!==iJ)C0("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.")}else P0("WebGLTextures: Unsupported texture color space:",T);return F}function $J(M){if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement)U.width=M.naturalWidth||M.width,U.height=M.naturalHeight||M.height;else if(typeof VideoFrame<"u"&&M instanceof VideoFrame)U.width=M.displayWidth,U.height=M.displayHeight;else U.width=M.width,U.height=M.height;return U}this.allocateTextureUnit=u,this.resetTextureUnits=o,this.getTextureUnits=p,this.setTextureUnits=n,this.setTexture2D=t,this.setTexture2DArray=e,this.setTexture3D=H0,this.setTextureCube=M0,this.rebindTextures=b0,this.setupRenderTarget=FJ,this.updateRenderTargetMipmap=bJ,this.updateMultisampleRenderTarget=OJ,this.setupDepthRenderbuffer=m0,this.setupFrameBufferTexture=v0,this.useMultisampledRTT=j,this.isReversedDepthBuffer=function(){return $.buffers.depth.getReversed()}}function uU(J,Q){function $(Z,W=d9){let K,H=h0.getTransfer(W);if(Z===iJ)return J.UNSIGNED_BYTE;if(Z===j7)return J.UNSIGNED_SHORT_4_4_4_4;if(Z===y7)return J.UNSIGNED_SHORT_5_5_5_1;if(Z===kZ)return J.UNSIGNED_INT_5_9_9_9_REV;if(Z===RZ)return J.UNSIGNED_INT_10F_11F_11F_REV;if(Z===FZ)return J.BYTE;if(Z===OZ)return J.SHORT;if(Z===b8)return J.UNSIGNED_SHORT;if(Z===S7)return J.INT;if(Z===P9)return J.UNSIGNED_INT;if(Z===q9)return J.FLOAT;if(Z===E9)return J.HALF_FLOAT;if(Z===MZ)return J.ALPHA;if(Z===LZ)return J.RGB;if(Z===J9)return J.RGBA;if(Z===g9)return J.DEPTH_COMPONENT;if(Z===p9)return J.DEPTH_STENCIL;if(Z===VZ)return J.RED;if(Z===v7)return J.RED_INTEGER;if(Z===m9)return J.RG;if(Z===f7)return J.RG_INTEGER;if(Z===b7)return J.RGBA_INTEGER;if(Z===L6||Z===V6||Z===B6||Z===z6)if(H===r0)if(K=Q.get("WEBGL_compressed_texture_s3tc_srgb"),K!==null){if(Z===L6)return K.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(Z===V6)return K.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(Z===B6)return K.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(Z===z6)return K.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(K=Q.get("WEBGL_compressed_texture_s3tc"),K!==null){if(Z===L6)return K.COMPRESSED_RGB_S3TC_DXT1_EXT;if(Z===V6)return K.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(Z===B6)return K.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(Z===z6)return K.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(Z===h7||Z===x7||Z===g7||Z===p7)if(K=Q.get("WEBGL_compressed_texture_pvrtc"),K!==null){if(Z===h7)return K.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(Z===x7)return K.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(Z===g7)return K.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(Z===p7)return K.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(Z===m7||Z===d7||Z===l7||Z===u7||Z===c7||Z===w6||Z===n7)if(K=Q.get("WEBGL_compressed_texture_etc"),K!==null){if(Z===m7||Z===d7)return H===r0?K.COMPRESSED_SRGB8_ETC2:K.COMPRESSED_RGB8_ETC2;if(Z===l7)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:K.COMPRESSED_RGBA8_ETC2_EAC;if(Z===u7)return K.COMPRESSED_R11_EAC;if(Z===c7)return K.COMPRESSED_SIGNED_R11_EAC;if(Z===w6)return K.COMPRESSED_RG11_EAC;if(Z===n7)return K.COMPRESSED_SIGNED_RG11_EAC}else return null;if(Z===s7||Z===i7||Z===o7||Z===a7||Z===r7||Z===t7||Z===e7||Z===JQ||Z===QQ||Z===$Q||Z===ZQ||Z===WQ||Z===KQ||Z===HQ)if(K=Q.get("WEBGL_compressed_texture_astc"),K!==null){if(Z===s7)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:K.COMPRESSED_RGBA_ASTC_4x4_KHR;if(Z===i7)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:K.COMPRESSED_RGBA_ASTC_5x4_KHR;if(Z===o7)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:K.COMPRESSED_RGBA_ASTC_5x5_KHR;if(Z===a7)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:K.COMPRESSED_RGBA_ASTC_6x5_KHR;if(Z===r7)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:K.COMPRESSED_RGBA_ASTC_6x6_KHR;if(Z===t7)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:K.COMPRESSED_RGBA_ASTC_8x5_KHR;if(Z===e7)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:K.COMPRESSED_RGBA_ASTC_8x6_KHR;if(Z===JQ)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:K.COMPRESSED_RGBA_ASTC_8x8_KHR;if(Z===QQ)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:K.COMPRESSED_RGBA_ASTC_10x5_KHR;if(Z===$Q)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:K.COMPRESSED_RGBA_ASTC_10x6_KHR;if(Z===ZQ)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:K.COMPRESSED_RGBA_ASTC_10x8_KHR;if(Z===WQ)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:K.COMPRESSED_RGBA_ASTC_10x10_KHR;if(Z===KQ)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:K.COMPRESSED_RGBA_ASTC_12x10_KHR;if(Z===HQ)return H===r0?K.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:K.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(Z===YQ||Z===XQ||Z===UQ)if(K=Q.get("EXT_texture_compression_bptc"),K!==null){if(Z===YQ)return H===r0?K.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:K.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(Z===XQ)return K.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(Z===UQ)return K.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(Z===GQ||Z===NQ||Z===I6||Z===qQ)if(K=Q.get("EXT_texture_compression_rgtc"),K!==null){if(Z===GQ)return K.COMPRESSED_RED_RGTC1_EXT;if(Z===NQ)return K.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(Z===I6)return K.COMPRESSED_RED_GREEN_RGTC2_EXT;if(Z===qQ)return K.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;if(Z===R8)return J.UNSIGNED_INT_24_8;return J[Z]!==void 0?J[Z]:null}return{convert:$}}var cU=`
void main() {
